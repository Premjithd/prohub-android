...
function buildTenantProfile(homeAccountId, localAccountId, tenantId, idTokenClaims) {
  if (idTokenClaims) {
    const { oid, sub, tid, name: name4, tfp, acr, preferred_username, upn, login_hint } = idTokenClaims;
...
var CacheManager = class {
   ...
   */
  readAppMetadataFromCache(environment2, correlationId) {
   ...
   * @param clientId
   */
  isAppMetadataFOCI(environment2, correlationId) {
    const appMetadata = this.readAppMetadataFromCache(environment2, correlationId);
   ...
   * @param environment
   */
  matchEnvironment(entity, environment2, correlationId) {
    if (this.staticAuthorityOptions) {
      const staticAliases = getAliasesFromStaticSources(this.staticAuthorityOptions, this.commonLogger, correlationId);
      if (staticAliases.includes(environment2) && staticAliases.includes(entity.environment)) {
        return true;
      }
    }
    const cloudMetadata = this.getAuthorityMetadataByAlias(environment2, correlationId);
...
function createIdTokenEntity(homeAccountId, environment2, idToken, clientId, tenantId) {
  const idTokenEntity = {
    credentialType: CredentialType.ID_TOKEN,
    homeAccountId,
    environment: environment2,
...
function createAccessTokenEntity(homeAccountId, environment2, accessToken, clientId, tenantId, scopes, expiresOn, extExpiresOn, base64Decode2, refreshOn, tokenType, userAssertionHash, keyId) {
  const atEntity = {
    homeAccountId,
...
function createRefreshTokenEntity(homeAccountId, environment2, refreshToken, clientId, familyId, userAssertionHash, expiresOn) {
  const rtEntity = {
    credentialType: CredentialType.REFRESH_TOKEN,
    homeAccountId,
    environment: environment2,
...
function generateAppMetadataKey({ environment: environment2, clientId }) {
...
function buildAccountToCache(cacheStorage, authority, homeAccountId, base64Decode2, correlationId, idTokenClaims, clientInfo, environment2, claimsTenantId, authCodePayload, nativeAccountId, logger) {
...
var RegionDiscovery = class _RegionDiscovery {
  ...
  async getRegionFromIMDS(version4, options) {
    return this.networkInterface.sendGetRequestAsync(`${IMDS_ENDPOINT}?api-version=${version4}&format=text`, options, IMDS_TIMEOUT);
  }
  /**
...
var SilentFlowClient = class {
  ...
  async acquireCachedToken(request) {
    ...
    const environment2 = request.authority || this.authority.getPreferredCache();
    const cacheRecord = {
      ...
      refreshToken: null,
      appMetadata: this.cacheManager.readAppMetadataFromCache(environment2, request.correlationId)
    };
...
var BrowserCacheManager = class extends CacheManager {
  ...
  getWrapperMetadata() {
    ...
    const version4 = this.internalStorage.getItem(InMemoryCacheKeys.WRAPPER_VER) || "";
    return [sku, version4];
  }
  /**
   *
...
var _MsalBroadcastService = class _MsalBroadcastService {
  constructor(msalInstance2, msalBroadcastConfig) {
    this.msalInstance = msalInstance2;
...
_MsalBroadcastService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
_MsalService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _MsalService,
...
_MsalGuard.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
  token: _MsalGuard,
...
_MsalInterceptor.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
_MsalRedirectComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MsalModule = class _MsalModule {
  static forRoot(msalInstance2, guardConfig, interceptorConfig) {
    return {
      ngModule: _MsalModule,
      providers: [{
        provide: MSAL_INSTANCE,
        useValue: msalInstance2
      }, {
...
_MsalModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MsalModule,
  declarations: [MsalRedirectComponent],
  imports: [CommonModule]
});
_MsalModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
_MsalCustomNavigationClient.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "src/app/layout/navbar/navbar.ts", lineNumber: 33 });
})();
...
var BottomNavComponent = class _BottomNavComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BottomNavComponent, selectors: [["app-bottom-nav"]], decls: 10, vars: 6, consts: [[1, "bottom-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", 3, "routerLinkActiveOptions"], [4, "ngIf"], ["routerLink", "/services", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/find-a-pro", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/auth/login", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/pending-jobs", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/post-job", "routerLinkActive", "active", 1, "nav-item", "post-btn"], ["routerLink", "/profile", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/available-jobs", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/my-jobs-pro", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/notifications", "routerLinkActive", "active", "matBadgeColor", "warn", "matBadgeSize", "small", 1, "nav-item", 3, "matBadge"], ["routerLink", "/admin-users", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/admin-materials", "routerLinkActive", "active", 1, "nav-item"], ["routerLink", "/messages", "routerLinkActive", "active", 1, "nav-item"]], template: function BottomNavComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.auth.isAuthenticated() && ctx.isProUser());
      \u0275\u0275advance();
...
var _c06 = ["sidenav"];
function MainLayout_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "Admin mode \u2014 browsing as ");
    ...
    \u0275\u0275listener("click", function MainLayout_div_0_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.exitImpersonation());
    });
    \u0275\u0275elementStart(9, "mat-icon");
    \u0275\u0275text(10, "logout");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11, " Exit Impersonation ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" (", ctx_r2.auth.getUserType(), ")");
  }
}
var MainLayout = class _MainLayout {
  ...
  ngOnInit() {
    this.router.events.pipe(filter((e) => e instanceof NavigationEnd), takeUntil(this.destroy$)).subscribe(() => this.sidenav?.close());
  }
  ngOnDestroy() {
    this.destroy$.next();
    this.destroy$.complete();
  ...
  static \u0275fac = function MainLayout_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MainLayout)(\u0275\u0275directiveInject(Auth), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayout, selectors: [["app-main-layout"]], viewQuery: function MainLayout_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c06, 5);
    }
    if (rf & 2) {
  ...
  }, decls: 12, vars: 1, consts: [["sidenav", ""], ["class", "impersonation-banner", 4, "ngIf"], ["mode", "over"], [3, "menuItemClicked"], [3, "toggleSidenav"], [1, "main-content"], [1, "container"], [1, "impersonation-banner"], [1, "exit-impersonation-btn", 3, "click"]], template: function MainLayout_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275template(0, MainLayout_div_0_Template, 12, 2, "div", 1);
      \u0275\u0275elementStart(1, "mat-sidenav-container")(2, "mat-sidenav", 2, 0)(4, "app-sidebar", 3);
      \u0275\u0275listener("menuItemClicked", function MainLayout_Template_app_sidebar_menuItemClicked_4_listener() {
        \u0275\u0275restoreView(_r1);
        const sidenav_r4 = \u0275\u0275reference(3);
        return \u0275\u0275resetView(sidenav_r4.close());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "mat-sidenav-content")(6, "app-navbar", 4);
      \u0275\u0275listener("toggleSidenav", function MainLayout_Template_app_navbar_toggleSidenav_6_listener() {
        \u0275\u0275restoreView(_r1);
        const sidenav_r4 = \u0275\u0275reference(3);
        return \u0275\u0275resetView(sidenav_r4.toggle());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "main", 5)(8, "div", 6);
    ...
    if (rf & 2) {
      \u0275\u0275property("ngIf", ctx.auth.isImpersonating());
    }
  }, dependencies: [
    CommonModule,
    NgIf,
    ...
    FooterComponent,
    BottomNavComponent
  ], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  min-height: 100vh;\n}\n.impersonation-banner[_ngcontent-%COMP%] {\n  position: sticky;\n  top: 0;\n  z-index: 1100;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.6rem 1.5rem;\n  background: #f59e0b;\n  color: #1a1a1a;\n  font-size: 0.9rem;\n  font-weight: 500;\n}\n.impersonation-banner[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1.2rem;\n  width: 1.2rem;\n  height: 1.2rem;\n}\n.impersonation-banner[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.impersonation-banner[_ngcontent-%COMP%]   .exit-impersonation-btn[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n  padding: 0.3rem 0.9rem;\n  border: 2px solid #1a1a1a;\n  border-radius: 4px;\n  background: transparent;\n  color: #1a1a1a;\n  font-size: 0.85rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: background 0.15s;\n}\n.impersonation-banner[_ngcontent-%COMP%]   .exit-impersonation-btn[_ngcontent-%COMP%]:hover {\n  background: rgba(0, 0, 0, 0.1);\n}\n.impersonation-banner[_ngcontent-%COMP%]   .exit-impersonation-btn[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  width: 1rem;\n  height: 1rem;\n}\nmat-sidenav-container[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.main-content[_ngcontent-%COMP%] {\n  padding: 2rem 0;\n  min-height: calc(100vh - var(--nav-height) - 64px);\n}\n@media (max-width: 768px) {\n  .main-content[_ngcontent-%COMP%] {\n    padding: 1rem 0;\n    padding-bottom: calc(var(--bottom-nav-height) + 1rem);\n    min-height: calc(100vh - var(--nav-height) - var(--bottom-nav-height));\n  }\n}\n/*# sourceMappingURL=main-layout.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MainLayout, [{
    ...
    args: [{ selector: "app-main-layout", standalone: true, imports: [
      ...
      FooterComponent,
      BottomNavComponent
    ], template: '<div *ngIf="auth.isImpersonating()" class="impersonation-banner">\n  <mat-icon>engineering</mat-icon>\n  <span>Admin mode \u2014 browsing as <strong>{{ auth.getName() }}</strong> ({{ auth.getUserType() }})</span>\n  <button class="exit-impersonation-btn" (click)="exitImpersonation()">\n    <mat-icon>logout</mat-icon>\n    Exit Impersonation\n  </button>\n</div>\n\n<mat-sidenav-container>\n  <mat-sidenav #sidenav mode="over">\n    <app-sidebar (menuItemClicked)="sidenav.close()"></app-sidebar>\n  </mat-sidenav>\n\n  <mat-sidenav-content>\n    <app-navbar (toggleSidenav)="sidenav.toggle()"></app-navbar>\n\n    <main class="main-content">\n      <div class="container">\n        <router-outlet></router-outlet>\n      </div>\n    </main>\n\n    <app-footer></app-footer>\n  </mat-sidenav-content>\n</mat-sidenav-container>\n\n<!-- Fixed bottom navigation (visible on mobile only) -->\n<app-bottom-nav></app-bottom-nav>\n', styles: ["/* src/app/layout/main-layout/main-layout.scss */\n:host {\n  display: flex;\n  flex-direction: column;\n  min-height: 100vh;\n}\n.impersonation-banner {\n  position: sticky;\n  top: 0;\n  z-index: 1100;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.6rem 1.5rem;\n  background: #f59e0b;\n  color: #1a1a1a;\n  font-size: 0.9rem;\n  font-weight: 500;\n}\n.impersonation-banner mat-icon {\n  font-size: 1.2rem;\n  width: 1.2rem;\n  height: 1.2rem;\n}\n.impersonation-banner span {\n  flex: 1;\n}\n.impersonation-banner .exit-impersonation-btn {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n  padding: 0.3rem 0.9rem;\n  border: 2px solid #1a1a1a;\n  border-radius: 4px;\n  background: transparent;\n  color: #1a1a1a;\n  font-size: 0.85rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: background 0.15s;\n}\n.impersonation-banner .exit-impersonation-btn:hover {\n  background: rgba(0, 0, 0, 0.1);\n}\n.impersonation-banner .exit-impersonation-btn mat-icon {\n  font-size: 1rem;\n  width: 1rem;\n  height: 1rem;\n}\nmat-sidenav-container {\n  flex: 1;\n}\n.main-content {\n  padding: 2rem 0;\n  min-height: calc(100vh - var(--nav-height) - 64px);\n}\n@media (max-width: 768px) {\n  .main-content {\n    padding: 1rem 0;\n    padding-bottom: calc(var(--bottom-nav-height) + 1rem);\n    min-height: calc(100vh - var(--nav-height) - var(--bottom-nav-height));\n  }\n}\n/*# sourceMappingURL=main-layout.css.map */\n"] }]
  }], () => [{ type: Auth }, { type: Router }], { sidenav: [{
    type: ViewChild,
    args: ["sidenav"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayout, { className: "MainLayout", filePath: "src/app/layout/main-layout/main-layout.ts", lineNumber: 31 });
})();
...
var AdminGuard = class _AdminGuard {
  ...
  static \u0275fac = function AdminGuard_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminGuard)(\u0275\u0275inject(Auth), \u0275\u0275inject(Router));
  };
...
var ProGuard = class _ProGuard {
  ...
  static \u0275fac = function ProGuard_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ProGuard)(\u0275\u0275inject(Auth), \u0275\u0275inject(Router));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ProGuard, factory: _ProGuard.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ProGuard, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], () => [{ type: Auth }, { type: Router }], null);
})();
...
var AuthInterceptor = class _AuthInterceptor {
  ...
  httpDirect;
  constructor(storage, router, httpBackend) {
  ...
  handle401(request, next) {
    ...
    if (this.refreshing) {
      return this.refreshSubject.pipe(filter((token) => token !== null), take(1), switchMap((token) => next.handle(this.attachToken(request, token))));
    }
    this.refreshing = true;
    this.refreshSubject.next(null);
    return this.httpDirect.post(`${environment.apiUrl}/auth/refresh`, { refreshToken }).pipe(switchMap((data) => {
  ...
  static \u0275fac = function AuthInterceptor_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AuthInterceptor)(\u0275\u0275inject(StorageService), \u0275\u0275inject(Router), \u0275\u0275inject(HttpBackend));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AuthInterceptor, [{
    type: Injectable
  }], () => [{ type: StorageService }, { type: Router }, { type: HttpBackend }], null);
})();

// src/app/app.config.ts
var msalConfig = {
  auth: {
    clientId: "06de8cc3-b92d-416d-ba2b-6bc939ca20fb",
    // Replace with your registered app's client ID
    authority: `https://login.microsoftonline.com/b33c0879-0364-4a0f-9d84-ff1a7420fed5`,
    // Using provided tenant ID
...
var IdleTimeoutService = class _IdleTimeoutService {
  ...
  platformId;
  idleTimer;
  IDLE_TIME_LIMIT = 30 * 60 * 1e3;
  // 30 minutes in milliseconds
  isInitialized = false;
  constructor(auth, router, ngZone, platformId) {
    this.auth = auth;
    this.router = router;
    this.ngZone = ngZone;
  ...
  static \u0275fac = function IdleTimeoutService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _IdleTimeoutService)(\u0275\u0275inject(Auth), \u0275\u0275inject(Router), \u0275\u0275inject(NgZone), \u0275\u0275inject(PLATFORM_ID));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _IdleTimeoutService, factory: _IdleTimeoutService.\u0275fac, providedIn: "root" });
};
(() => {
  ...
  }], () => [{ type: Auth }, { type: Router }, { type: NgZone }, { type: Object, decorators: [{
    type: Inject,
    args: [PLATFORM_ID]
  }] }], null);
})();
...
var App = class _App {
  ...
  }, dependencies: [RouterOutlet, FormsModule], encapsulation: 2 });
};
(() => {

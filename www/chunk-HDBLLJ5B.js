...
// src/app/shared/map-view/map-view.ts
var L = __toESM(require_leaflet_src());
var _c02 = ["mapEl"];
function MapViewComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "span", 5);
    \u0275\u0275text(2, "location_off");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "No location data available for these results");
    \u0275\u0275elementEnd()();
  }
}
var MapViewComponent = class _MapViewComponent {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => requestAnimationFrame(() => requestAnimationFrame(() => this.initMap())));
  }
  ngOnChanges(changes) {
    if (!this.map)
      return;
  ...
  refreshMarkers() {
    ...
    for (const m of validMarkers) {
      ...
      const marker2 = L.marker([m.lat, m.lng], { icon }).bindPopup(this.buildPopup(m), { maxWidth: 220 });
      marker2.on("click", () => {
        this.zone.run(() => this.markerClick.emit(m.id));
      });
      marker2.addTo(this.layerGroup);
      this.leafletMarkers.set(m.id, marker2);
      bounds.push([m.lat, m.lng]);
      if (m.type === "pro" && m.radiusKm) {
        L.circle([m.lat, m.lng], {
          radius: m.radiusKm * 1e3,
          color: "#667eea",
          fillColor: "#667eea",
          fillOpacity: 0.08,
          weight: 1.5,
  ...
  applyHighlight() {
    for (const [id, marker2] of this.leafletMarkers) {
    ...
    if (this.highlightedId !== null) {
      const marker2 = this.leafletMarkers.get(this.highlightedId);
  ...
  panTo(id) {
    const m = this.markers.find((x) => x.id === id);
    const marker2 = this.leafletMarkers.get(id);
    if (m && marker2) {
  ...
  static \u0275fac = function MapViewComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MapViewComponent)(\u0275\u0275directiveInject(NgZone));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MapViewComponent, selectors: [["app-map-view"]], viewQuery: function MapViewComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c02, 5);
    }
    if (rf & 2) {
  ...
  }, inputs: { markers: "markers", loading: "loading", highlightedId: "highlightedId" }, outputs: { markerClick: "markerClick" }, features: [\u0275\u0275NgOnChangesFeature], decls: 4, vars: 1, consts: [["mapEl", ""], [1, "map-wrapper"], [1, "map-el"], ["class", "map-no-data", 4, "ngIf"], [1, "map-no-data"], [1, "material-icons"]], template: function MapViewComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 1);
      \u0275\u0275element(1, "div", 2, 0);
      \u0275\u0275template(3, MapViewComponent_div_3_Template, 5, 0, "div", 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", ctx.markers.length === 0 && !ctx.loading);
    }
  }, dependencies: [CommonModule, NgIf], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n  height: 100%;\n  min-height: 400px;\n}\n.map-wrapper[_ngcontent-%COMP%] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  min-height: 400px;\n}\n.map-el[_ngcontent-%COMP%] {\n  position: absolute;\n  inset: 0;\n  min-height: 400px;\n}\n.map-no-data[_ngcontent-%COMP%] {\n  position: absolute;\n  inset: 0;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  background: rgba(245, 245, 245, 0.88);\n  color: #888;\n  gap: 10px;\n  z-index: 1000;\n  pointer-events: none;\n}\n.map-no-data[_ngcontent-%COMP%]   .material-icons[_ngcontent-%COMP%] {\n  font-size: 40px;\n}\n.map-no-data[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 14px;\n}\n/*# sourceMappingURL=map-view.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MapViewComponent, [{
    type: Component,
    args: [{ selector: "app-map-view", standalone: true, imports: [CommonModule], template: `
  ...
  `, styles: ["/* angular:styles/component:scss;8ee5c9973d0659ec47e1080ec037448a069df30678745983ddafe7e0a3391c91;C:/repos/yProHub/prohub-ui/src/app/shared/map-view/map-view.ts */\n:host {\n  display: block;\n  width: 100%;\n  height: 100%;\n  min-height: 400px;\n}\n.map-wrapper {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  min-height: 400px;\n}\n.map-el {\n  position: absolute;\n  inset: 0;\n  min-height: 400px;\n}\n.map-no-data {\n  position: absolute;\n  inset: 0;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  background: rgba(245, 245, 245, 0.88);\n  color: #888;\n  gap: 10px;\n  z-index: 1000;\n  pointer-events: none;\n}\n.map-no-data .material-icons {\n  font-size: 40px;\n}\n.map-no-data p {\n  margin: 0;\n  font-size: 14px;\n}\n/*# sourceMappingURL=map-view.css.map */\n"] }]
  }], () => [{ type: NgZone }], { markers: [{
    type: Input
  }], loading: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MapViewComponent, { className: "MapViewComponent", filePath: "src/app/shared/map-view/map-view.ts", lineNumber: 47 });
})();

// src/app/features/available-jobs/available-jobs.ts
var _c03 = (a0) => ({ km: a0 });
var _c12 = (a0, a1) => ({ showing: a0, total: a1 });
var _c22 = (a0) => ({ count: a0 });
var _c32 = (a0, a1) => ({ page: a0, total: a1 });
function AvailableJobsComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
...
function AvailableJobsComponent_button_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function AvailableJobsComponent_button_39_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      ctx_r0.searchText = "";
...
function AvailableJobsComponent_mat_option_48_Template(rf, ctx) {
  if (rf & 1) {
...
function AvailableJobsComponent_button_71_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 33);
    \u0275\u0275listener("click", function AvailableJobsComponent_button_71_Template_button_click_0_listener() {
...
function AvailableJobsComponent_div_72_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 1, "AVAILABLE_JOBS.PROXIMITY_WITHIN", \u0275\u0275pureFunction1(4, _c03, ctx_r0.activeRadiusKm)));
  }
}
function AvailableJobsComponent_div_73_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 1, "AVAILABLE_JOBS.PROXIMITY_SET_LOCATION"));
  }
}
function AvailableJobsComponent_div_74_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(4, 1, "AVAILABLE_JOBS.LOADING"));
  }
}
function AvailableJobsComponent_div_75_div_2_p_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "AVAILABLE_JOBS.EMPTY_PROXIMITY", \u0275\u0275pureFunction1(4, _c03, ctx_r0.activeRadiusKm)), " ");
  }
}
function AvailableJobsComponent_div_75_div_2_p_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(2, 1, "AVAILABLE_JOBS.EMPTY_FILTERS"), " ");
  }
}
function AvailableJobsComponent_div_75_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "translate");
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AvailableJobsComponent_div_75_div_2_p_6_Template, 3, 6, "p", 47)(7, AvailableJobsComponent_div_75_div_2_p_7_Template, 3, 3, "p", 47);
    \u0275\u0275elementStart(8, "button", 6);
    \u0275\u0275listener("click", function AvailableJobsComponent_div_75_div_2_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.resetFilters());
    });
    \u0275\u0275elementStart(9, "mat-icon");
    \u0275\u0275text(10, "restart_alt");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "translate");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 4, "AVAILABLE_JOBS.EMPTY_TITLE"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r0.proximityFilterApplied);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.proximityFilterApplied);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(12, 6, "AVAILABLE_JOBS.CLEAR_FILTERS"), " ");
  }
}
function AvailableJobsComponent_div_75_div_3_span_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, "AVAILABLE_JOBS.NO_COORDS", \u0275\u0275pureFunction1(4, _c22, ctx_r0.filteredJobs.length - ctx_r0.mapMarkers.length)), " ");
  }
}
function AvailableJobsComponent_div_75_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275template(3, AvailableJobsComponent_div_75_div_3_span_3_Template, 3, 6, "span", 49);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 2, "AVAILABLE_JOBS.SHOWING_COUNT", \u0275\u0275pureFunction2(5, _c12, ctx_r0.filteredJobs.length, ctx_r0.total)), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r0.mapMarkers.length < ctx_r0.filteredJobs.length);
  }
}
function AvailableJobsComponent_div_75_div_5_mat_chip_9_Template(rf, ctx) {
  if (rf & 1) {
...
function AvailableJobsComponent_div_75_div_5_div_25_Template(rf, ctx) {
  if (rf & 1) {
...
function AvailableJobsComponent_div_75_div_5_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "mat-icon");
    \u0275\u0275text(2, "location_on");
    \u0275\u0275elementEnd();
...
function AvailableJobsComponent_div_75_div_5_div_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const job_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(5, 2, job_r8.distanceKm, "1.1-1"), " ", \u0275\u0275pipeBind1(6, 5, "AVAILABLE_JOBS.KM_AWAY"));
  }
}
function AvailableJobsComponent_div_75_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 51);
    \u0275\u0275listener("mouseenter", function AvailableJobsComponent_div_75_div_5_Template_div_mouseenter_0_listener() {
      const job_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.hoverJob(job_r8.id));
    })("mouseleave", function AvailableJobsComponent_div_75_div_5_Template_div_mouseleave_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, AvailableJobsComponent_div_75_div_5_mat_chip_9_Template, 4, 3, "mat-chip", 57);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div", 61)(17, "div", 62)(18, "h3");
    \u0275\u0275text(19);
    \u0275\u0275pipe(20, "translate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(25, AvailableJobsComponent_div_75_div_5_div_25_Template, 5, 2, "div", 65)(26, AvailableJobsComponent_div_75_div_5_div_26_Template, 5, 1, "div", 65)(27, AvailableJobsComponent_div_75_div_5_div_27_Template, 7, 7, "div", 66);
    \u0275\u0275elementStart(28, "div", 67)(29, "mat-icon");
    \u0275\u0275text(30, "schedule");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span");
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 67)(34, "mat-icon");
    ...
    \u0275\u0275pipe(39, "date");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(40, "div", 68)(41, "button", 6);
    \u0275\u0275listener("click", function AvailableJobsComponent_div_75_div_5_Template_button_click_41_listener() {
      const job_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 19, "AVAILABLE_JOBS.BUDGET"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.formatPrice(job_r8.budget));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 21, "AVAILABLE_JOBS.DESCRIPTION"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind3(23, 23, job_r8.description, 0, 150), "", job_r8.description && job_r8.description.length > 150 ? "..." : "");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind1(38, 27, "AVAILABLE_JOBS.POSTED"), " ", \u0275\u0275pipeBind2(39, 29, job_r8.createdAt, "MMM dd, yyyy"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(45, 32, "AVAILABLE_JOBS.VIEW_DETAILS"), " ");
  }
}
function AvailableJobsComponent_div_75_div_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 74)(1, "button", 75);
    \u0275\u0275listener("click", function AvailableJobsComponent_div_75_div_6_div_1_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function AvailableJobsComponent_div_75_div_6_div_1_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 3, "AVAILABLE_JOBS.PAGE_INFO", \u0275\u0275pureFunction2(6, _c32, ctx_r0.page, ctx_r0.totalPages)));
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r0.page >= ctx_r0.totalPages);
  }
}
function AvailableJobsComponent_div_75_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 72);
    \u0275\u0275template(1, AvailableJobsComponent_div_75_div_6_div_1_Template, 10, 9, "div", 73);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function AvailableJobsComponent_div_75_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 77)(1, "app-map-view", 78);
    \u0275\u0275listener("markerClick", function AvailableJobsComponent_div_75_div_7_Template_app_map_view_markerClick_1_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function AvailableJobsComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 38);
    \u0275\u0275template(2, AvailableJobsComponent_div_75_div_2_Template, 13, 8, "div", 39)(3, AvailableJobsComponent_div_75_div_3_Template, 4, 8, "div", 40);
    \u0275\u0275elementStart(4, "div", 41);
    \u0275\u0275template(5, AvailableJobsComponent_div_75_div_5_Template, 46, 34, "div", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AvailableJobsComponent_div_75_div_6_Template, 2, 1, "div", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, AvailableJobsComponent_div_75_div_7_Template, 2, 3, "div", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AvailableJobsComponent = class _AvailableJobsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AvailableJobsComponent, selectors: [["app-available-jobs"]], viewQuery: function AvailableJobsComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AvailableJobsComponent_Template_button_click_11_listener() {
      ...
      \u0275\u0275listener("click", function AvailableJobsComponent_Template_button_click_17_listener() {
        return ctx.goHome();
      });
      ...
      \u0275\u0275pipe(21, "translate");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(22, AvailableJobsComponent_div_22_Template, 5, 1, "div", 7);
      \u0275\u0275elementStart(23, "mat-expansion-panel", 8)(24, "mat-expansion-panel-header")(25, "mat-panel-title")(26, "mat-icon");
      \u0275\u0275text(27, "tune");
      \u0275\u0275elementEnd();
      \u0275\u0275text(28);
      \u0275\u0275pipe(29, "translate");
      ...
      \u0275\u0275pipe(34, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(35, "mat-icon", 11);
      \u0275\u0275text(36, "search");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "input", 12);
      \u0275\u0275pipe(38, "translate");
      \u0275\u0275twoWayListener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_37_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_37_listener() {
        return ctx.onSearchChange();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(39, AvailableJobsComponent_button_39_Template, 3, 0, "button", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "mat-form-field", 14)(41, "mat-label");
      \u0275\u0275text(42);
      \u0275\u0275pipe(43, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "mat-select", 15);
      \u0275\u0275twoWayListener("ngModelChange", function AvailableJobsComponent_Template_mat_select_ngModelChange_44_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.selectedCategoryId, $event) || (ctx.selectedCategoryId = $event);
        return $event;
      });
      \u0275\u0275listener("selectionChange", function AvailableJobsComponent_Template_mat_select_selectionChange_44_listener() {
      ...
      \u0275\u0275pipe(47, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(48, AvailableJobsComponent_mat_option_48_Template, 2, 2, "mat-option", 17);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(49, "mat-form-field", 18)(50, "mat-label");
      \u0275\u0275text(51);
      \u0275\u0275pipe(52, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "input", 19);
      \u0275\u0275twoWayListener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_53_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.minBudget, $event) || (ctx.minBudget = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_53_listener() {
        return ctx.onBudgetFilterChange();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(54, "mat-form-field", 18)(55, "mat-label");
      \u0275\u0275text(56);
      \u0275\u0275pipe(57, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "input", 20);
      \u0275\u0275twoWayListener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_58_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.maxBudget, $event) || (ctx.maxBudget = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function AvailableJobsComponent_Template_input_ngModelChange_58_listener() {
        return ctx.onBudgetFilterChange();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "button", 21);
      \u0275\u0275listener("click", function AvailableJobsComponent_Template_button_click_59_listener() {
        return ctx.resetFilters();
      });
      \u0275\u0275elementStart(60, "mat-icon");
      \u0275\u0275text(61, "restart_alt");
      \u0275\u0275elementEnd();
      \u0275\u0275text(62);
      \u0275\u0275pipe(63, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(64, "div", 22)(65, "mat-icon", 23);
      \u0275\u0275text(66, "my_location");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(67, "span", 24);
      \u0275\u0275text(68);
      \u0275\u0275pipe(69, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "div", 25);
      \u0275\u0275template(71, AvailableJobsComponent_button_71_Template, 2, 3, "button", 26);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(72, AvailableJobsComponent_div_72_Template, 6, 6, "div", 27)(73, AvailableJobsComponent_div_73_Template, 6, 3, "div", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275template(74, AvailableJobsComponent_div_74_Template, 5, 3, "div", 29)(75, AvailableJobsComponent_div_75_Template, 8, 7, "div", 30);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 28, "AVAILABLE_JOBS.TITLE"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 30, "AVAILABLE_JOBS.SUBTITLE"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(ctx.showMap ? "view_list" : "map");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.showMap ? \u0275\u0275pipeBind1(15, 32, "AVAILABLE_JOBS.LIST_ONLY") : \u0275\u0275pipeBind1(16, 34, "AVAILABLE_JOBS.SHOW_MAP"), " ");
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(21, 36, "AVAILABLE_JOBS.BACK_TO_HOME"), " ");
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.errorMessage);
      \u0275\u0275advance();
      \u0275\u0275property("expanded", true);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(29, 38, "AVAILABLE_JOBS.FILTERS_TITLE"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(34, 40, "AVAILABLE_JOBS.SEARCH_LABEL"));
      \u0275\u0275advance(4);
      \u0275\u0275twoWayProperty("ngModel", ctx.searchText);
      \u0275\u0275property("placeholder", \u0275\u0275pipeBind1(38, 42, "AVAILABLE_JOBS.SEARCH_PLACEHOLDER"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.searchText);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 44, "AVAILABLE_JOBS.CATEGORY_LABEL"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.selectedCategoryId);
      \u0275\u0275advance();
      \u0275\u0275property("value", null);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(47, 46, "AVAILABLE_JOBS.CATEGORY_ALL"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.categories);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(52, 48, "AVAILABLE_JOBS.MIN_BUDGET"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.minBudget);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(57, 50, "AVAILABLE_JOBS.MAX_BUDGET"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.maxBudget);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(63, 52, "AVAILABLE_JOBS.RESET"), " ");
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(69, 54, "AVAILABLE_JOBS.DISTANCE"));
      \u0275\u0275advance(3);
...
(() => {
  ...
  <div class="page-header">
    <div class="header-content">
      <div>
        <h1>{{ 'AVAILABLE_JOBS.TITLE' | translate }}</h1>
        <p class="subtitle">{{ 'AVAILABLE_JOBS.SUBTITLE' | translate }}</p>
      </div>
      <div class="header-actions">
        <button mat-stroked-button (click)="toggleMap()" class="map-toggle-btn">
          <mat-icon>{{ showMap ? 'view_list' : 'map' }}</mat-icon>
          {{ showMap ? ('AVAILABLE_JOBS.LIST_ONLY' | translate) : ('AVAILABLE_JOBS.SHOW_MAP' | translate) }}
        </button>
        <button mat-raised-button color="primary" (click)="goHome()">
          <mat-icon>home</mat-icon>
          {{ 'AVAILABLE_JOBS.BACK_TO_HOME' | translate }}
        </button>
      </div>
    </div>
  </div>
  ...
  <mat-expansion-panel class="filters-panel" [expanded]="true">
    <mat-expansion-panel-header>
      <mat-panel-title>
        ...
        {{ 'AVAILABLE_JOBS.FILTERS_TITLE' | translate }}
      </mat-panel-title>
    </mat-expansion-panel-header>

    <div class="filters-grid">
      <mat-form-field appearance="outline" class="filter-field search-field">
        <mat-label>{{ 'AVAILABLE_JOBS.SEARCH_LABEL' | translate }}</mat-label>
        <mat-icon matPrefix>search</mat-icon>
        <input matInput [(ngModel)]="searchText" (ngModelChange)="onSearchChange()" [placeholder]="'AVAILABLE_JOBS.SEARCH_PLACEHOLDER' | translate">
      ...
      <mat-form-field appearance="outline" class="filter-field">
        <mat-label>{{ 'AVAILABLE_JOBS.CATEGORY_LABEL' | translate }}</mat-label>
        <mat-select [(ngModel)]="selectedCategoryId" (selectionChange)="onFilterChange()">
          <mat-option [value]="null">{{ 'AVAILABLE_JOBS.CATEGORY_ALL' | translate }}</mat-option>
          <mat-option *ngFor="let cat of categories" [value]="cat.id">{{ cat.name }}</mat-option>
        </mat-select>
      </mat-form-field>

      <mat-form-field appearance="outline" class="filter-field budget-field">
        <mat-label>{{ 'AVAILABLE_JOBS.MIN_BUDGET' | translate }}</mat-label>
        <input matInput type="number" [(ngModel)]="minBudget" (ngModelChange)="onBudgetFilterChange()" min="0" placeholder="0">
      </mat-form-field>

      <mat-form-field appearance="outline" class="filter-field budget-field">
        <mat-label>{{ 'AVAILABLE_JOBS.MAX_BUDGET' | translate }}</mat-label>
        <input matInput type="number" [(ngModel)]="maxBudget" (ngModelChange)="onBudgetFilterChange()" min="0">
      </mat-form-field>

      <button mat-stroked-button (click)="resetFilters()" class="reset-btn">
        <mat-icon>restart_alt</mat-icon>
        {{ 'AVAILABLE_JOBS.RESET' | translate }}
      </button>
    </div>

    <div class="radius-row">
      <mat-icon class="radius-icon">my_location</mat-icon>
      <span class="radius-label">{{ 'AVAILABLE_JOBS.DISTANCE' | translate }}</span>
    ...
    <div *ngIf="proximityFilterApplied && activeRadiusKm" class="proximity-banner">
      ...
      <span>{{ 'AVAILABLE_JOBS.PROXIMITY_WITHIN' | translate: {km: activeRadiusKm} }}</span>
    </div>
    <div *ngIf="selectedRadiusKm != null && !proLocationSet" class="proximity-warning">
      <mat-icon>location_off</mat-icon>
      <span>{{ 'AVAILABLE_JOBS.PROXIMITY_SET_LOCATION' | translate }}</span>
    </div>
  </mat-expansion-panel>
  ...
  <div *ngIf="loading" class="loading-container">
    ...
    <p>{{ 'AVAILABLE_JOBS.LOADING' | translate }}</p>
  </div>
  ...
  <div *ngIf="!loading" class="split-layout" [class.map-hidden]="!showMap">
    ...
    <div class="jobs-panel">
      ...
      <div *ngIf="filteredJobs.length === 0" class="empty-state">
        ...
        <h2>{{ 'AVAILABLE_JOBS.EMPTY_TITLE' | translate }}</h2>
        <p *ngIf="proximityFilterApplied">
          {{ 'AVAILABLE_JOBS.EMPTY_PROXIMITY' | translate: {km: activeRadiusKm} }}
        </p>
        <p *ngIf="!proximityFilterApplied">
          {{ 'AVAILABLE_JOBS.EMPTY_FILTERS' | translate }}
        </p>
        <button mat-raised-button color="primary" (click)="resetFilters()">
          <mat-icon>restart_alt</mat-icon>
          {{ 'AVAILABLE_JOBS.CLEAR_FILTERS' | translate }}
        </button>
      </div>

      <div *ngIf="filteredJobs.length > 0" class="jobs-count-bar">
        {{ 'AVAILABLE_JOBS.SHOWING_COUNT' | translate: {showing: filteredJobs.length, total: total} }}
        <span *ngIf="mapMarkers.length < filteredJobs.length" class="no-loc-note">
          {{ 'AVAILABLE_JOBS.NO_COORDS' | translate: {count: filteredJobs.length - mapMarkers.length} }}
        </span>
      </div>
        ...
        >
          <div class="job-header">
            ...
            <div class="job-budget">
              <span class="budget-label">{{ 'AVAILABLE_JOBS.BUDGET' | translate }}</span>
          ...
          <div class="job-content">
            <div class="job-section">
              <h3>{{ 'AVAILABLE_JOBS.DESCRIPTION' | translate }}</h3>
            ...
            <div class="job-details">
              ...
              <div class="detail-item distance-item" *ngIf="job.distanceKm != null">
                ...
                <span class="distance-badge">{{ job.distanceKm | number:'1.1-1' }} {{ 'AVAILABLE_JOBS.KM_AWAY' | translate }}</span>
              </div>
              ...
              <div class="detail-item">
                ...
                <span>{{ 'AVAILABLE_JOBS.POSTED' | translate }} {{ job.createdAt | date: 'MMM dd, yyyy' }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="job-actions">
            <button mat-raised-button color="primary" (click)="viewJobDetails(job.id)">
              ...
              {{ 'AVAILABLE_JOBS.VIEW_DETAILS' | translate }}
            </button>
          </div>
        </div>
      </div>
      ...
      <div *ngIf="total > 0" class="pagination-row">
        <div class="pagination-controls" *ngIf="totalPages > 1">
          ...
          <span class="page-info">{{ 'AVAILABLE_JOBS.PAGE_INFO' | translate: {page: page, total: totalPages} }}</span>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AvailableJobsComponent, { className: "AvailableJobsComponent", filePath: "src/app/features/available-jobs/available-jobs.ts", lineNumber: 47 });
})();
export {
  AvailableJobsComponent
};
//# sourceMappingURL=chunk-HDBLLJ5B.js.map

...
var Auth = class _Auth {
  ...
  USER_ID_KEY = "user_id";
  IS_PROFILE_COMPLETE_KEY = "is_profile_complete";
  ...
  registerProStep1(data) {
    return this.api.postRaw("auth/pro/register/draft", data);
  }
  registerProStep2(proId, data) {
    return this.api.postRaw(`auth/pro/register/complete/${proId}`, data).pipe(tap((response) => {
      if (response)
        this.storeSession(response);
    }));
  }
...
//# sourceMappingURL=chunk-6CNFBV5T.js.map

...
var NotificationService = class _NotificationService {
  ...
  getNotifications(unreadOnly = false, page = 1, pageSize = 20) {
    return this.http.get(`${this.base}?unreadOnly=${unreadOnly}&page=${page}&pageSize=${pageSize}`);
  }
  getUnreadCount() {
...
var SignalRService = class _SignalRService {
  ...
  onNewNotification$ = this.newNotification$$.asObservable();
  connect(token) {
    if (this.connection)
      return;
    this.connection = new HubConnectionBuilder().withUrl(`${environment.hubUrl}/hubs/notifications`, {
    ...
    this.connection.start().then(() => console.log("SignalR connected")).catch((err) => console.error("SignalR connection error:", err));
  }
  disconnect() {
...
//# sourceMappingURL=chunk-DW26NECD.js.map

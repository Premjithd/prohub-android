import {
  MaterialService
} from "./chunk-CZAQ2FPU.js";
import {
  MatSelectModule
} from "./chunk-Z4O25NSQ.js";
import "./chunk-WZFXCFSK.js";
import {
  PaymentService,
  RazorpayCheckoutComponent
} from "./chunk-V7IPEUU5.js";
import {
  MatChipsModule
...
// src/app/features/job-details/bid-submission-dialog.component.ts
function BidSubmissionDialogComponent_mat_error_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " Quoted price is required ");
    \u0275\u0275elementEnd();
  }
}
function BidSubmissionDialogComponent_mat_error_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function BidSubmissionDialogComponent_mat_error_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function BidSubmissionDialogComponent_mat_error_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function BidSubmissionDialogComponent_mat_error_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " Duration must be at least 1 day ");
    \u0275\u0275elementEnd();
  }
}
function BidSubmissionDialogComponent_mat_error_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " Description cannot exceed 2000 characters ");
    \u0275\u0275elementEnd();
  }
}
function BidSubmissionDialogComponent_mat_error_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " Message cannot exceed 500 characters ");
    \u0275\u0275elementEnd();
  }
}
function BidSubmissionDialogComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21);
    \u0275\u0275element(1, "mat-spinner", 22);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "Submitting your bid...");
    \u0275\u0275elementEnd()();
  }
}
var BidSubmissionDialogComponent = class _BidSubmissionDialogComponent {
  fb;
  materialService;
  dialogRef;
  data;
  ...
  destroy$ = new Subject();
  constructor(fb, materialService, dialogRef, data) {
    this.fb = fb;
  ...
  initializeForm() {
    ...
    this.bidForm = this.fb.group({
      ...
      materialsDescription: ["", [Validators.maxLength(2e3)]],
      message: ["", [Validators.maxLength(500)]]
    });
  }
  loadMaterials() {
    if (this.data.serviceCategoryId) {
      this.materialService.getMaterials(this.data.serviceCategoryId, true).pipe(takeUntil(this.destroy$)).subscribe({
        next: (materials) => {
  ...
  static \u0275fac = function BidSubmissionDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BidSubmissionDialogComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(MaterialService), \u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BidSubmissionDialogComponent, selectors: [["app-bid-submission-dialog"]], features: [\u0275\u0275ProvidersFeature([provideNativeDateAdapter()])], decls: 67, vars: 19, consts: [["picker", ""], [1, "bid-dialog-container"], [1, "dialog-header"], ["mat-icon-button", "", 1, "close-btn", 3, "click", "disabled"], [1, "dialog-content"], [1, "job-title"], [1, "job-budget"], [3, "formGroup"], ["appearance", "outline", 1, "full-width"], ["matInput", "", "type", "number", "formControlName", "quotedPrice", "placeholder", "Enter your quoted price", "step", "100", "min", "0"], ["matPrefix", ""], [4, "ngIf"], ["matInput", "", "formControlName", "commenceDate", "placeholder", "Select start date", 3, "matDatepicker", "min"], ["matIconSuffix", "", 3, "for"], ["matInput", "", "type", "number", "formControlName", "expectedDurationDays", "placeholder", "Number of days to complete", "min", "1"], ["matInput", "", "formControlName", "materialsDescription", "placeholder", "Describe materials you'll bring, brands, quality, or any special details...", "rows", "4"], ["matInput", "", "formControlName", "message", "placeholder", "Tell the client why you're a good fit for this job...", "rows", "4"], ["class", "loading-overlay", 4, "ngIf"], [1, "dialog-actions"], ["mat-button", "", 3, "click", "disabled"], ["mat-raised-button", "", "color", "primary", 1, "submit-btn", 3, "click", "disabled"], [1, "loading-overlay"], ["diameter", "40"]], template: function BidSubmissionDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h2");
      \u0275\u0275text(3, "Submit Your Bid");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "button", 3);
      \u0275\u0275listener("click", function BidSubmissionDialogComponent_Template_button_click_4_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(15);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(16, "form", 7)(17, "mat-form-field", 8)(18, "mat-label");
      \u0275\u0275text(19, "Quoted Price (\u20B9)");
      \u0275\u0275elementEnd();
      \u0275\u0275element(20, "input", 9);
      \u0275\u0275elementStart(21, "mat-icon", 10);
      \u0275\u0275text(22, "attach_money");
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, BidSubmissionDialogComponent_mat_error_23_Template, 2, 0, "mat-error", 11)(24, BidSubmissionDialogComponent_mat_error_24_Template, 2, 0, "mat-error", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "mat-form-field", 8)(26, "mat-label");
      \u0275\u0275text(27, "Commence Date");
      \u0275\u0275elementEnd();
      \u0275\u0275element(28, "input", 12)(29, "mat-datepicker-toggle", 13)(30, "mat-datepicker", null, 0);
      \u0275\u0275template(32, BidSubmissionDialogComponent_mat_error_32_Template, 2, 0, "mat-error", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "mat-form-field", 8)(34, "mat-label");
      \u0275\u0275text(35, "Expected Duration (Days)");
      \u0275\u0275elementEnd();
      \u0275\u0275element(36, "input", 14);
      \u0275\u0275elementStart(37, "mat-icon", 10);
      \u0275\u0275text(38, "schedule");
      \u0275\u0275elementEnd();
      \u0275\u0275template(39, BidSubmissionDialogComponent_mat_error_39_Template, 2, 0, "mat-error", 11)(40, BidSubmissionDialogComponent_mat_error_40_Template, 2, 0, "mat-error", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "mat-form-field", 8)(42, "mat-label");
      \u0275\u0275text(43, "Materials & Details");
      \u0275\u0275elementEnd();
      \u0275\u0275element(44, "textarea", 15);
      \u0275\u0275elementStart(45, "mat-icon", 10);
      \u0275\u0275text(46, "build");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "mat-hint");
      \u0275\u0275text(48);
      \u0275\u0275elementEnd();
      \u0275\u0275template(49, BidSubmissionDialogComponent_mat_error_49_Template, 2, 0, "mat-error", 11);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(50, "mat-form-field", 8)(51, "mat-label");
      \u0275\u0275text(52, "Message to Client (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275element(53, "textarea", 16);
      \u0275\u0275elementStart(54, "mat-icon", 10);
      \u0275\u0275text(55, "message");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(56, "mat-hint");
      \u0275\u0275text(57);
      \u0275\u0275elementEnd();
      \u0275\u0275template(58, BidSubmissionDialogComponent_mat_error_58_Template, 2, 0, "mat-error", 11);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(59, BidSubmissionDialogComponent_div_59_Template, 4, 0, "div", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(60, "div", 18)(61, "button", 19);
      \u0275\u0275listener("click", function BidSubmissionDialogComponent_Template_button_click_61_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onCancel());
      });
      \u0275\u0275text(62, " Cancel ");
      ...
      \u0275\u0275listener("click", function BidSubmissionDialogComponent_Template_button_click_63_listener() {
        \u0275\u0275restoreView(_r1);
    ...
    if (rf & 2) {
      ...
      let tmp_15_0;
      let tmp_16_0;
      const picker_r2 = \u0275\u0275reference(31);
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", ctx.submitting);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(ctx.data.jobTitle);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.data.jobBudget);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.bidForm);
      \u0275\u0275advance(7);
      \u0275\u0275property("ngIf", (tmp_5_0 = ctx.bidForm.get("quotedPrice")) == null ? null : tmp_5_0.hasError("required"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_6_0 = ctx.bidForm.get("quotedPrice")) == null ? null : tmp_6_0.hasError("min"));
      \u0275\u0275advance(4);
      \u0275\u0275property("matDatepicker", picker_r2)("min", ctx.minDate);
      \u0275\u0275advance();
      \u0275\u0275property("for", picker_r2);
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", (tmp_10_0 = ctx.bidForm.get("commenceDate")) == null ? null : tmp_10_0.hasError("required"));
      \u0275\u0275advance(7);
      \u0275\u0275property("ngIf", (tmp_11_0 = ctx.bidForm.get("expectedDurationDays")) == null ? null : tmp_11_0.hasError("required"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_12_0 = ctx.bidForm.get("expectedDurationDays")) == null ? null : tmp_12_0.hasError("min"));
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1("", (((tmp_13_0 = ctx.bidForm.get("materialsDescription")) == null ? null : tmp_13_0.value) || "").length, "/2000");
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_14_0 = ctx.bidForm.get("materialsDescription")) == null ? null : tmp_14_0.hasError("maxlength"));
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1("", (((tmp_15_0 = ctx.bidForm.get("message")) == null ? null : tmp_15_0.value) || "").length, "/500");
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_16_0 = ctx.bidForm.get("message")) == null ? null : tmp_16_0.hasError("maxlength"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.submitting);
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.submitting);
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", !ctx.bidForm.valid || ctx.submitting);
    }
  }, dependencies: [
    CommonModule,
    NgIf,
    ...
    MatProgressSpinnerModule,
    MatProgressSpinner
  ], styles: ["\n\n.bid-dialog-container[_ngcontent-%COMP%] {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  min-width: 450px;\n  max-height: 90vh;\n}\n.dialog-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem 1.5rem 1rem 1.5rem;\n  border-bottom: 1px solid #e0e0e0;\n  margin-bottom: 1.5rem;\n}\n.dialog-header[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 1.5rem;\n  color: #333;\n}\n.dialog-header[_ngcontent-%COMP%]   .close-btn[_ngcontent-%COMP%] {\n  margin: -0.5rem;\n}\n.dialog-content[_ngcontent-%COMP%] {\n  padding: 0 1.5rem;\n  flex: 1;\n  overflow-y: auto;\n  position: relative;\n}\n.dialog-content[_ngcontent-%COMP%]   .job-title[_ngcontent-%COMP%], \n.dialog-content[_ngcontent-%COMP%]   .job-budget[_ngcontent-%COMP%] {\n  margin: 0.5rem 0;\n  color: #666;\n  font-size: 0.95rem;\n}\n.dialog-content[_ngcontent-%COMP%]   .job-title[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%], \n.dialog-content[_ngcontent-%COMP%]   .job-budget[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  color: #333;\n  font-weight: 600;\n}\n.dialog-content[_ngcontent-%COMP%]   .job-budget[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n}\n.dialog-content[_ngcontent-%COMP%]   form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1.5rem;\n}\n.dialog-content[_ngcontent-%COMP%]   .full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.dialog-content[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.dialog-content[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  font-family: inherit;\n  resize: vertical;\n}\n.dialog-content[_ngcontent-%COMP%]   .loading-overlay[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(255, 255, 255, 0.9);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 1rem;\n  z-index: 999;\n}\n.dialog-content[_ngcontent-%COMP%]   .loading-overlay[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  color: #666;\n  font-size: 0.9rem;\n}\n.dialog-actions[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n  padding: 1.5rem;\n  border-top: 1px solid #e0e0e0;\n  background-color: #f9f9f9;\n}\n.dialog-actions[_ngcontent-%COMP%]   .submit-btn[_ngcontent-%COMP%] {\n  min-width: 150px;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n/*# sourceMappingURL=bid-submission-dialog.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BidSubmissionDialogComponent, [{
    type: Component,
    args: [{ selector: "app-bid-submission-dialog", standalone: true, providers: [provideNativeDateAdapter()], imports: [
      CommonModule,
      ReactiveFormsModule,
      MatDialogModule,
      MatFormFieldModule,
  ...
  `, styles: ["/* angular:styles/component:scss;dbf343273efdfc18adec7735a8c05c43ee0b2ebe8d85788716504ad570ee4628;C:/repos/yProHub/prohub-ui/src/app/features/job-details/bid-submission-dialog.component.ts */\n.bid-dialog-container {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  min-width: 450px;\n  max-height: 90vh;\n}\n.dialog-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem 1.5rem 1rem 1.5rem;\n  border-bottom: 1px solid #e0e0e0;\n  margin-bottom: 1.5rem;\n}\n.dialog-header h2 {\n  margin: 0;\n  font-size: 1.5rem;\n  color: #333;\n}\n.dialog-header .close-btn {\n  margin: -0.5rem;\n}\n.dialog-content {\n  padding: 0 1.5rem;\n  flex: 1;\n  overflow-y: auto;\n  position: relative;\n}\n.dialog-content .job-title,\n.dialog-content .job-budget {\n  margin: 0.5rem 0;\n  color: #666;\n  font-size: 0.95rem;\n}\n.dialog-content .job-title strong,\n.dialog-content .job-budget strong {\n  color: #333;\n  font-weight: 600;\n}\n.dialog-content .job-budget {\n  margin-bottom: 1.5rem;\n}\n.dialog-content form {\n  display: flex;\n  flex-direction: column;\n  gap: 1.5rem;\n}\n.dialog-content .full-width {\n  width: 100%;\n}\n.dialog-content mat-form-field {\n  width: 100%;\n}\n.dialog-content textarea {\n  font-family: inherit;\n  resize: vertical;\n}\n.dialog-content .loading-overlay {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(255, 255, 255, 0.9);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 1rem;\n  z-index: 999;\n}\n.dialog-content .loading-overlay p {\n  margin: 0;\n  color: #666;\n  font-size: 0.9rem;\n}\n.dialog-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n  padding: 1.5rem;\n  border-top: 1px solid #e0e0e0;\n  background-color: #f9f9f9;\n}\n.dialog-actions .submit-btn {\n  min-width: 150px;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n/*# sourceMappingURL=bid-submission-dialog.component.css.map */\n"] }]
  }], () => [{ type: FormBuilder }, { type: MaterialService }, { type: MatDialogRef }, { type: void 0, decorators: [{
    type: Inject,
    args: [MAT_DIALOG_DATA]
  }] }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BidSubmissionDialogComponent, { className: "BidSubmissionDialogComponent", filePath: "src/app/features/job-details/bid-submission-dialog.component.ts", lineNumber: 278 });
})();

// src/app/features/job-details/job-details.ts
function JobDetailsComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
...
function JobDetailsComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "mat-icon");
    \u0275\u0275text(2, "check_circle");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4, "Successfully submitted your interest in this job!");
    \u0275\u0275elementEnd()();
  }
}
function JobDetailsComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function JobDetailsComponent_div_10_section_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 23)(1, "h2");
    \u0275\u0275text(2, "Attachments");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 43)(4, "div", 44)(5, "mat-icon");
...
function JobDetailsComponent_div_10_div_66_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (ctx_r0.job.assignedPro == null ? null : ctx_r0.job.assignedPro.proName) || "Professional", " ");
  }
}
function JobDetailsComponent_div_10_div_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "span", 33);
    \u0275\u0275text(2, "Assignment Status:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 45);
    \u0275\u0275text(4, "Unassigned - Available for Pro Bid");
    \u0275\u0275elementEnd()();
  }
}
function JobDetailsComponent_div_10_div_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46)(1, "span", 34);
    \u0275\u0275text(2, "Not yet bid");
    \u0275\u0275elementEnd()();
  }
}
function JobDetailsComponent_div_10_div_72_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54)(1, "mat-icon", 55);
    \u0275\u0275text(2, "info");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "span", 56);
    \u0275\u0275text(5, "Reason:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r0.userBidRejectionReason);
  }
}
function JobDetailsComponent_div_10_div_72_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
    \u0275\u0275text(2, "Your Proposed Amount:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\u20B9", \u0275\u0275pipeBind2(5, 1, ctx_r0.userBidAmount, "1.2-2"));
  }
}
function JobDetailsComponent_div_10_div_72_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 1, ctx_r0.userBidCommenceDate, "MMM dd, yyyy"));
  }
}
function JobDetailsComponent_div_10_div_72_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.userBidExpectedDuration, " days");
  }
}
function JobDetailsComponent_div_10_div_72_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
    \u0275\u0275text(2, "Materials Needed:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.userBidMaterials);
  }
}
function JobDetailsComponent_div_10_div_72_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
    \u0275\u0275text(2, "Your Message:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.userBidMessage);
  }
}
function JobDetailsComponent_div_10_div_72_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "span", 59);
    \u0275\u0275text(2, "Bid Expires:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 61);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "date");
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 1, ctx_r0.userBidExpiresAt, "MMM dd, yyyy"));
  }
}
function JobDetailsComponent_div_10_div_72_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "p", 64);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u2713 Bid submitted on ", \u0275\u0275pipeBind2(3, 1, ctx_r0.job.createdAt, "MMM dd, yyyy"));
  }
}
function JobDetailsComponent_div_10_div_72_div_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 65)(1, "p", 66);
    \u0275\u0275text(2, "Your bid was not accepted. You can try submit a new bid.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 67);
    \u0275\u0275listener("click", function JobDetailsComponent_div_10_div_72_div_15_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.submitBid());
    });
    \u0275\u0275elementStart(4, "mat-icon");
    \u0275\u0275text(5, "refresh");
    \u0275\u0275elementEnd();
    \u0275\u0275text(6, " Submit New Bid ");
    \u0275\u0275elementEnd()();
  }
}
function JobDetailsComponent_div_10_div_72_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, JobDetailsComponent_div_10_div_72_div_6_Template, 8, 1, "div", 50);
    \u0275\u0275elementStart(7, "div", 51);
    \u0275\u0275template(8, JobDetailsComponent_div_10_div_72_div_8_Template, 6, 4, "div", 52)(9, JobDetailsComponent_div_10_div_72_div_9_Template, 6, 4, "div", 52)(10, JobDetailsComponent_div_10_div_72_div_10_Template, 5, 1, "div", 52)(11, JobDetailsComponent_div_10_div_72_div_11_Template, 5, 1, "div", 52)(12, JobDetailsComponent_div_10_div_72_div_12_Template, 5, 1, "div", 52)(13, JobDetailsComponent_div_10_div_72_div_13_Template, 6, 4, "div", 52)(14, JobDetailsComponent_div_10_div_72_div_14_Template, 4, 4, "div", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, JobDetailsComponent_div_10_div_72_div_15_Template, 7, 0, "div", 53);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("bid-rejected", ctx_r0.userBidStatus === "Rejected");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("rejected-icon", ctx_r0.userBidStatus === "Rejected");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.userBidStatus === "Rejected" ? "cancel" : "check_circle");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.userBidStatus === "Rejected" ? "Bid Rejected" : "Bid Submitted");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidStatus === "Rejected" && ctx_r0.userBidRejectionReason);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r0.userBidAmount);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidCommenceDate !== null && ctx_r0.userBidCommenceDate !== void 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidExpectedDuration !== null && ctx_r0.userBidExpectedDuration !== void 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidMaterials && ctx_r0.userBidMaterials.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidMessage && ctx_r0.userBidMessage.length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidExpiresAt !== null && ctx_r0.userBidExpiresAt !== void 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.userBidAmount && !ctx_r0.userBidCommenceDate && !ctx_r0.userBidExpectedDuration && !ctx_r0.userBidMaterials && !ctx_r0.userBidMessage && !ctx_r0.userBidExpiresAt);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userBidStatus === "Rejected" && ctx_r0.job.status === "Open");
  }
}
function JobDetailsComponent_div_10_div_73_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function JobDetailsComponent_div_10_div_73_div_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("sent", msg_r4.senderType === "Pro");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(msg_r4.senderType === "Pro" ? "You" : "Job Poster");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 5, msg_r4.sentAt, "MMM dd, HH:mm"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(msg_r4.content);
  }
}
function JobDetailsComponent_div_10_div_73_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 73);
    \u0275\u0275template(1, JobDetailsComponent_div_10_div_73_div_5_div_1_Template, 9, 8, "div", 74);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.jobMessages);
  }
}
function JobDetailsComponent_div_10_div_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "span", 33);
    \u0275\u0275text(2, "Message History:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 68);
    \u0275\u0275template(4, JobDetailsComponent_div_10_div_73_div_4_Template, 4, 0, "div", 69)(5, JobDetailsComponent_div_10_div_73_div_5_Template, 2, 1, "div", 70);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.loadingMessages && ctx_r0.jobMessages.length > 0);
  }
}
function JobDetailsComponent_div_10_mat_icon_76_Template(rf, ctx) {
  if (rf & 1) {
...
function JobDetailsComponent_div_10_mat_icon_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
...
function JobDetailsComponent_div_10_mat_spinner_78_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 80);
  }
}
function JobDetailsComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 12)(2, "div", 13)(3, "div", 14)(4, "h1", 15);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div", 22)(17, "section", 23)(18, "h2");
    \u0275\u0275text(19, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "p", 24);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "section", 25)(23, "div", 26)(24, "div", 27)(25, "mat-icon");
    \u0275\u0275text(26, "location_on");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "h3");
    \u0275\u0275text(28, "Location");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "p", 28);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 26)(32, "div", 27)(33, "mat-icon");
    \u0275\u0275text(34, "schedule");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 26)(40, "div", 27)(41, "mat-icon");
    \u0275\u0275text(42, "calendar_today");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "h3");
    \u0275\u0275text(44, "Posted Date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "p", 28);
    \u0275\u0275text(46);
    \u0275\u0275pipe(47, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 26)(49, "div", 27)(50, "mat-icon");
    \u0275\u0275text(51, "person");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(56, JobDetailsComponent_div_10_section_56_Template, 9, 1, "section", 29);
    \u0275\u0275elementStart(57, "section", 30)(58, "h2");
    \u0275\u0275text(59, "Status Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "div", 31)(61, "div", 32)(62, "span", 33);
    \u0275\u0275text(63, "Current Status:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "span", 34);
    \u0275\u0275text(65);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(66, JobDetailsComponent_div_10_div_66_Template, 5, 1, "div", 35)(67, JobDetailsComponent_div_10_div_67_Template, 5, 0, "div", 35);
    \u0275\u0275elementStart(68, "div", 32)(69, "span", 33);
    \u0275\u0275text(70, "Your Bid Status:");
    \u0275\u0275elementEnd();
    \u0275\u0275template(71, JobDetailsComponent_div_10_div_71_Template, 3, 0, "div", 36)(72, JobDetailsComponent_div_10_div_72_Template, 16, 15, "div", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275template(73, JobDetailsComponent_div_10_div_73_Template, 6, 2, "div", 35);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(74, "div", 38)(75, "button", 39);
    \u0275\u0275listener("click", function JobDetailsComponent_div_10_Template_button_click_75_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.submitBid());
    });
    \u0275\u0275template(76, JobDetailsComponent_div_10_mat_icon_76_Template, 2, 0, "mat-icon", 40)(77, JobDetailsComponent_div_10_mat_icon_77_Template, 2, 0, "mat-icon", 40)(78, JobDetailsComponent_div_10_mat_spinner_78_Template, 1, 0, "mat-spinner", 41);
    \u0275\u0275text(79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "button", 42);
    \u0275\u0275listener("click", function JobDetailsComponent_div_10_Template_button_click_80_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.goBack());
    });
    \u0275\u0275elementStart(81, "mat-icon");
    \u0275\u0275text(82, "arrow_back");
    \u0275\u0275elementEnd();
    \u0275\u0275text(83, " Back to Available Jobs ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.job.title);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((ctx_r0.job.category == null ? null : ctx_r0.job.category.name) || "Uncategorized");
    \u0275\u0275advance();
    \u0275\u0275classProp("status-open", ctx_r0.job.status === "Open");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.job.status, " ");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.formatPrice(ctx_r0.job.budget));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r0.job.description);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(ctx_r0.job.location);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r0.job.timeline);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(47, 25, ctx_r0.job.createdAt, "MMM dd, yyyy HH:mm"));
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate1(" ", (ctx_r0.job.user == null ? null : ctx_r0.job.user.firstName) && (ctx_r0.job.user == null ? null : ctx_r0.job.user.lastName) ? (ctx_r0.job.user == null ? null : ctx_r0.job.user.firstName) + " " + (ctx_r0.job.user == null ? null : ctx_r0.job.user.lastName) : (ctx_r0.job.user == null ? null : ctx_r0.job.user.name) || "User", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.job.attachments);
    \u0275\u0275advance(8);
    \u0275\u0275classProp("status-open", ctx_r0.job.status === "Open");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.job.status);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.job.assignedProId);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.job.assignedProId);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", !ctx_r0.userHasBid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userHasBid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userHasBid && ctx_r0.jobMessages.length > 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r0.submittingBid || ctx_r0.userHasBid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.submittingBid && !ctx_r0.userHasBid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.userHasBid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.submittingBid);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.userHasBid ? "Already Bid on This Job" : ctx_r0.submittingBid ? "Submitting..." : "Send a Bid", " ");
  }
}
var JobDetailsComponent = class _JobDetailsComponent {
  ...
  userBidAmount = null;
  userBidStatus = null;
  userBidCommenceDate = null;
  userBidExpectedDuration = null;
  userBidMaterials = null;
  userBidExpiresAt = null;
  userBidRejectionReason = null;
  jobMessages = [];
  loadingMessages = false;
  currentUserId;
  destroy$ = new Subject();
  constructor(jobService, paymentService, auth, router, route, cdr, dialog, snackBar, fb) {
  ...
  checkIfUserHasBid() {
    if (!this.job)
      return;
    this.jobService.getJobBids(this.jobId).pipe(takeUntil(this.destroy$)).subscribe({
      next: (bids) => {
  ...
  loadJobMessages() {
    ...
    this.jobService.getJobMessages(this.jobId).pipe(takeUntil(this.destroy$)).subscribe({
      next: (messages) => {
        this.jobMessages = messages.filter(
          (msg) => msg.recipientId === this.currentUserId || msg.senderType === "Pro" && msg.senderId === this.currentUserId || msg.senderType === "User"
          // Show all messages from users (job posters)
        );
  ...
  getAssignedProName() {
    if (!this.job?.assignedPro)
      return "Professional";
    const pro = this.job.assignedPro;
  ...
  submitBid() {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result && result.quotedPrice !== void 0 && result.commenceDate !== void 0) {
        this.submitBidWithCustomData(result);
      }
    });
  }
  submitBidWithCustomData(bidData) {
    if (!this.job) {
      this.errorMessage = "Job information not loaded";
      return;
    }
    ...
    this.jobService.submitJobBid(this.job.id, bidPayload).pipe(takeUntil(this.destroy$)).subscribe({
      next: (response) => {
        ...
        this.cdr.markForCheck();
        this.checkIfUserHasBid();
        this.snackBar.open("Bid submitted! Proceed to payment?", "Pay Now", { duration: 5e3 }).onAction().subscribe(() => {
      ...
      next: (bids) => {
        ...
        dialogRef.afterClosed().subscribe((result) => {
          if (result && result.success) {
            this.snackBar.open("Payment successful! Job is now active.", "Close", { duration: 5e3 });
            this.checkIfUserHasBid();
          }
        });
      },
  ...
  static \u0275fac = function JobDetailsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _JobDetailsComponent)(\u0275\u0275directiveInject(JobService), \u0275\u0275directiveInject(PaymentService), \u0275\u0275directiveInject(Auth), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(ChangeDetectorRef), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(FormBuilder));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _JobDetailsComponent, selectors: [["app-job-details"]], decls: 11, vars: 4, consts: [[1, "job-details-wrapper"], [1, "page-header"], [1, "header-content"], ["mat-button", "", "mat-raised-button", "", "color", "primary", 3, "click"], ["class", "alert alert-error", 4, "ngIf"], ["class", "alert alert-success", 4, "ngIf"], ["class", "loading-container", 4, "ngIf"], ["class", "job-details-container", 4, "ngIf"], [1, "alert", "alert-error"], [1, "alert", "alert-success"], [1, "loading-container"], [1, "job-details-container"], [1, "job-details-card"], [1, "job-header"], [1, "job-title-section"], [1, "job-title"], [1, "job-meta"], [1, "job-category"], [1, "job-status"], [1, "job-budget"], [1, "budget-label"], [1, "price"], [1, "job-content"], [1, "job-section"], [1, "description"], [1, "job-details-grid"], [1, "detail-box"], [1, "detail-header"], [1, "detail-value"], ["class", "job-section", 4, "ngIf"], [1, "job-section", "status-section"], [1, "status-info"], [1, "info-item"], [1, "info-label"], [1, "info-value"], ["class", "info-item", 4, "ngIf"], ["class", "bid-status-container", 4, "ngIf"], ["class", "bid-status-container bid-submitted", 3, "bid-rejected", 4, "ngIf"], [1, "job-actions"], ["mat-raised-button", "", "color", "primary", 1, "full-width", 3, "click", "disabled"], [4, "ngIf"], ["diameter", "20", "class", "button-spinner", 4, "ngIf"], ["mat-button", "", 1, "full-width", 3, "click"], [1, "attachments"], [1, "attachment-item"], [1, "info-value", "status-unassigned"], [1, "bid-status-container"], [1, "bid-status-container", "bid-submitted"], [1, "bid-status-header"], [1, "bid-status-text"], ["class", "rejection-reason-box", 4, "ngIf"], [1, "bid-details"], ["class", "bid-detail-item", 4, "ngIf"], ["class", "bid-resubmit-section", 4, "ngIf"], [1, "rejection-reason-box"], [1, "reason-icon"], [1, "reason-label"], [1, "reason-text"], [1, "bid-detail-item"], [1, "bid-detail-label"], [1, "bid-detail-value", "amount"], [1, "bid-detail-value"], [1, "bid-detail-value", "materials"], [1, "bid-detail-value", "message"], [2, "color", "#999", "font-size", "0.9rem"], [1, "bid-resubmit-section"], [1, "resubmit-message"], ["mat-raised-button", "", "color", "accent", 3, "click"], [1, "messages-section"], ["class", "messages-loading", 4, "ngIf"], ["class", "messages-list", 4, "ngIf"], [1, "messages-loading"], ["diameter", "20"], [1, "messages-list"], ["class", "message-item", 3, "sent", 4, "ngFor", "ngForOf"], [1, "message-item"], [1, "message-header"], [1, "sender-type"], [1, "message-time"], [1, "message-content"], ["diameter", "20", 1, "button-spinner"]], template: function JobDetailsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "button", 3);
      \u0275\u0275listener("click", function JobDetailsComponent_Template_button_click_3_listener() {
        return ctx.goBack();
      });
      \u0275\u0275elementStart(4, "mat-icon");
      \u0275\u0275text(5, "arrow_back");
      \u0275\u0275elementEnd();
      \u0275\u0275text(6, " Back to Jobs ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(7, JobDetailsComponent_div_7_Template, 5, 1, "div", 4)(8, JobDetailsComponent_div_8_Template, 5, 0, "div", 5)(9, JobDetailsComponent_div_9_Template, 4, 0, "div", 6)(10, JobDetailsComponent_div_10_Template, 84, 28, "div", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.bidSuccess);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.loading);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.loading && ctx.job);
    }
  }, dependencies: [CommonModule, NgForOf, NgIf, RouterModule, MatProgressSpinnerModule, MatProgressSpinner, MatIconModule, MatIcon, MatButtonModule, MatButton, MatSnackBarModule, MatDialogModule, MatInputModule, MatFormFieldModule, ReactiveFormsModule, DecimalPipe, DatePipe], styles: ['@charset "UTF-8";\n\n\n\n.job-details-wrapper[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  background:\n    linear-gradient(\n      135deg,\n      #f5f7fa 0%,\n      #c3cfe2 100%);\n  padding: 2rem;\n}\n.page-header[_ngcontent-%COMP%] {\n  max-width: 1000px;\n  margin: 0 auto 2rem;\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n}\n.page-header[_ngcontent-%COMP%]   .header-content[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 1rem;\n}\n@media (max-width: 768px) {\n  .page-header[_ngcontent-%COMP%]   .header-content[_ngcontent-%COMP%] {\n    width: 100%;\n    justify-content: space-between;\n  }\n}\n.page-header[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  white-space: nowrap;\n}\n.alert[_ngcontent-%COMP%] {\n  max-width: 1000px;\n  margin: 0 auto 2rem;\n  padding: 1rem;\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  font-size: 1rem;\n}\n.alert[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1.25rem;\n  width: 1.25rem;\n  height: 1.25rem;\n}\n.alert.alert-error[_ngcontent-%COMP%] {\n  background-color: #f8d7da;\n  color: #721c24;\n  border: 1px solid #f5c6cb;\n}\n.alert.alert-success[_ngcontent-%COMP%] {\n  background-color: #d4edda;\n  color: #155724;\n  border: 1px solid #c3e6cb;\n}\n.loading-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  min-height: 600px;\n  gap: 1rem;\n}\n.loading-container[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: #666;\n  font-size: 1.1rem;\n}\n.job-details-container[_ngcontent-%COMP%] {\n  max-width: 1000px;\n  margin: 0 auto;\n}\n.job-details-card[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 12px;\n  box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1);\n  overflow: hidden;\n}\n.job-header[_ngcontent-%COMP%] {\n  padding: 2rem;\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  color: white;\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  gap: 2rem;\n}\n@media (max-width: 768px) {\n  .job-header[_ngcontent-%COMP%] {\n    flex-direction: column;\n    gap: 1.5rem;\n  }\n}\n.job-title-section[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.job-title[_ngcontent-%COMP%] {\n  font-size: 2rem;\n  margin: 0 0 1rem 0;\n  font-weight: 600;\n}\n@media (max-width: 768px) {\n  .job-title[_ngcontent-%COMP%] {\n    font-size: 1.5rem;\n  }\n}\n.job-meta[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\n.job-meta[_ngcontent-%COMP%]   .job-category[_ngcontent-%COMP%] {\n  display: inline-block;\n  background-color: rgba(255, 255, 255, 0.2);\n  color: white;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  font-size: 0.95rem;\n  font-weight: 500;\n}\n.job-meta[_ngcontent-%COMP%]   .job-status[_ngcontent-%COMP%] {\n  display: inline-block;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  font-size: 0.95rem;\n  font-weight: 600;\n  background-color: rgba(255, 255, 255, 0.2);\n}\n.job-meta[_ngcontent-%COMP%]   .job-status.status-open[_ngcontent-%COMP%] {\n  background-color: #4caf50;\n  color: white;\n}\n.job-budget[_ngcontent-%COMP%] {\n  text-align: right;\n}\n.job-budget[_ngcontent-%COMP%]   .budget-label[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.9rem;\n  opacity: 0.9;\n  margin-bottom: 0.5rem;\n}\n.job-budget[_ngcontent-%COMP%]   .price[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 2rem;\n  font-weight: 700;\n}\n.job-content[_ngcontent-%COMP%] {\n  padding: 2rem;\n}\n.job-section[_ngcontent-%COMP%] {\n  margin-bottom: 2.5rem;\n}\n.job-section[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  font-size: 1.3rem;\n  font-weight: 600;\n  color: #333;\n  margin: 0 0 1rem 0;\n  padding-bottom: 0.5rem;\n  border-bottom: 2px solid #f0f0f0;\n}\n.job-section[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%] {\n  color: #555;\n  line-height: 1.8;\n  font-size: 1rem;\n  margin: 0;\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n.job-details-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 1.5rem;\n  margin-bottom: 2.5rem;\n}\n.detail-box[_ngcontent-%COMP%] {\n  background: #f9f9f9;\n  padding: 1.5rem;\n  border-radius: 8px;\n  border-left: 4px solid #667eea;\n}\n.detail-box[_ngcontent-%COMP%]   .detail-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  margin-bottom: 1rem;\n}\n.detail-box[_ngcontent-%COMP%]   .detail-header[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n  color: #667eea;\n}\n.detail-box[_ngcontent-%COMP%]   .detail-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  font-size: 0.95rem;\n  font-weight: 600;\n  color: #333;\n  margin: 0;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.detail-box[_ngcontent-%COMP%]   .detail-value[_ngcontent-%COMP%] {\n  color: #555;\n  font-size: 1rem;\n  margin: 0;\n  line-height: 1.6;\n}\n.attachments[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.attachments[_ngcontent-%COMP%]   .attachment-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.75rem;\n  background: #f9f9f9;\n  border-radius: 6px;\n  color: #555;\n}\n.attachments[_ngcontent-%COMP%]   .attachment-item[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1.2rem;\n  width: 1.2rem;\n  height: 1.2rem;\n  color: #667eea;\n}\n.status-section[_ngcontent-%COMP%] {\n  background: #f9f9f9;\n  padding: 1.5rem;\n  border-radius: 8px;\n  margin-bottom: 2rem;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.75rem 0;\n  border-bottom: 1px solid #e0e0e0;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%]:last-child {\n  border-bottom: none;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%]   .info-label[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: #333;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%]   .info-value[_ngcontent-%COMP%] {\n  color: #555;\n  font-weight: 500;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%]   .info-value.status-open[_ngcontent-%COMP%] {\n  background-color: #4caf50;\n  color: white;\n  padding: 0.4rem 0.8rem;\n  border-radius: 4px;\n  font-size: 0.9rem;\n}\n.status-section[_ngcontent-%COMP%]   .status-info[_ngcontent-%COMP%]   .info-item[_ngcontent-%COMP%]   .info-value.status-unassigned[_ngcontent-%COMP%] {\n  background-color: #ff9800;\n  color: white;\n  padding: 0.4rem 0.8rem;\n  border-radius: 4px;\n  font-size: 0.9rem;\n}\n.job-actions[_ngcontent-%COMP%] {\n  padding: 1.5rem 2rem;\n  background: #f9f9f9;\n  border-top: 1px solid #e0e0e0;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.job-actions[_ngcontent-%COMP%]   .full-width[_ngcontent-%COMP%] {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n}\n.job-actions[_ngcontent-%COMP%]   .full-width[_ngcontent-%COMP%]   .button-spinner[_ngcontent-%COMP%] {\n  display: inline-block;\n  margin: 0;\n}\n@media (max-width: 768px) {\n  .job-actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n    display: block;\n    width: 100%;\n  }\n}\n.back-btn[_ngcontent-%COMP%] {\n  color: white;\n  background: rgba(255, 255, 255, 0.2);\n}\n.back-btn[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.3);\n}\n@media (max-width: 600px) {\n  .job-details-wrapper[_ngcontent-%COMP%] {\n    padding: 1rem;\n  }\n  .job-header[_ngcontent-%COMP%] {\n    padding: 1.5rem;\n    flex-direction: column;\n  }\n  .job-header[_ngcontent-%COMP%]   .job-title[_ngcontent-%COMP%] {\n    font-size: 1.3rem;\n  }\n  .job-header[_ngcontent-%COMP%]   .job-budget[_ngcontent-%COMP%] {\n    width: 100%;\n    text-align: left;\n  }\n  .job-header[_ngcontent-%COMP%]   .job-budget[_ngcontent-%COMP%]   .price[_ngcontent-%COMP%] {\n    font-size: 1.5rem;\n  }\n  .job-content[_ngcontent-%COMP%] {\n    padding: 1rem;\n  }\n  .job-details-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n    gap: 1rem;\n  }\n}\n.bid-already-submitted[_ngcontent-%COMP%] {\n  color: #4caf50;\n  font-weight: 600;\n}\n.bid-already-submitted[_ngcontent-%COMP%]::before {\n  content: "\\2713  ";\n  margin-right: 0.25rem;\n}\n.bid-status-container[_ngcontent-%COMP%] {\n  width: 100%;\n  text-align: left;\n}\n.bid-status-container.bid-submitted[_ngcontent-%COMP%] {\n  background: #f0f8f4;\n  padding: 1rem;\n  border-radius: 8px;\n  border-left: 4px solid #4caf50;\n}\n.bid-status-container.bid-submitted.bid-rejected[_ngcontent-%COMP%] {\n  background: #fef5f5;\n  border-left-color: #f44336;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-status-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  margin-bottom: 1rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-status-header[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #4caf50;\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-status-header[_ngcontent-%COMP%]   mat-icon.rejected-icon[_ngcontent-%COMP%] {\n  color: #f44336;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-status-header[_ngcontent-%COMP%]   .bid-status-text[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: #2e7d32;\n  font-size: 1rem;\n}\n.bid-status-container.bid-rejected[_ngcontent-%COMP%]   .bid-status-header[_ngcontent-%COMP%]   .bid-status-text[_ngcontent-%COMP%] {\n  color: #c62828;\n}\n.bid-status-container[_ngcontent-%COMP%]   .rejection-reason-box[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.5rem;\n  background: #fff3f3;\n  border: 1px solid #f44336;\n  border-radius: 6px;\n  padding: 10px 12px;\n  margin-bottom: 1rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .rejection-reason-box[_ngcontent-%COMP%]   .reason-icon[_ngcontent-%COMP%] {\n  color: #c62828;\n  font-size: 18px;\n  width: 18px;\n  height: 18px;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.bid-status-container[_ngcontent-%COMP%]   .rejection-reason-box[_ngcontent-%COMP%]   .reason-label[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: #c62828;\n  font-size: 0.85rem;\n  margin-right: 4px;\n}\n.bid-status-container[_ngcontent-%COMP%]   .rejection-reason-box[_ngcontent-%COMP%]   .reason-text[_ngcontent-%COMP%] {\n  color: #555;\n  font-size: 0.9rem;\n  line-height: 1.4;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-detail-item[_ngcontent-%COMP%]   .bid-detail-label[_ngcontent-%COMP%] {\n  display: block;\n  font-weight: 600;\n  color: #333;\n  font-size: 0.9rem;\n  margin-bottom: 0.25rem;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-detail-item[_ngcontent-%COMP%]   .bid-detail-value[_ngcontent-%COMP%] {\n  margin: 0;\n  color: #555;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-detail-item[_ngcontent-%COMP%]   .bid-detail-value.amount[_ngcontent-%COMP%] {\n  font-size: 1.3rem;\n  font-weight: 700;\n  color: #4caf50;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-detail-item[_ngcontent-%COMP%]   .bid-detail-value.message[_ngcontent-%COMP%], \n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-detail-item[_ngcontent-%COMP%]   .bid-detail-value.materials[_ngcontent-%COMP%] {\n  font-size: 0.95rem;\n  line-height: 1.5;\n  background: white;\n  padding: 0.75rem;\n  border-radius: 6px;\n  border-left: 3px solid #4caf50;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-resubmit-section[_ngcontent-%COMP%] {\n  margin-top: 1.5rem;\n  padding-top: 1.5rem;\n  border-top: 1px solid rgba(244, 67, 54, 0.2);\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-resubmit-section[_ngcontent-%COMP%]   .resubmit-message[_ngcontent-%COMP%] {\n  margin: 0 0 1rem 0;\n  color: #c62828;\n  font-size: 0.9rem;\n  font-style: italic;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-resubmit-section[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  width: 100%;\n  justify-content: center;\n  gap: 8px;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .bid-resubmit-section[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  width: 1rem;\n  height: 1rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%] {\n  background: #f9f9f9;\n  border-radius: 8px;\n  padding: 1rem;\n  border: 1px solid #e0e0e0;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-loading[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.75rem;\n  padding: 1rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-loading[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  color: #666;\n  font-size: 0.9rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item[_ngcontent-%COMP%] {\n  background: white;\n  padding: 0.75rem;\n  border-radius: 6px;\n  border-left: 3px solid #2196f3;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item.sent[_ngcontent-%COMP%] {\n  background: #e3f2fd;\n  border-left-color: #1976d2;\n  margin-left: 1rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item[_ngcontent-%COMP%]   .message-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 0.5rem;\n  font-size: 0.85rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item[_ngcontent-%COMP%]   .message-header[_ngcontent-%COMP%]   .sender-type[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: #333;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item[_ngcontent-%COMP%]   .message-header[_ngcontent-%COMP%]   .message-time[_ngcontent-%COMP%] {\n  color: #999;\n  font-size: 0.8rem;\n}\n.bid-status-container[_ngcontent-%COMP%]   .bid-details[_ngcontent-%COMP%]   .messages-section[_ngcontent-%COMP%]   .messages-list[_ngcontent-%COMP%]   .message-item[_ngcontent-%COMP%]   .message-content[_ngcontent-%COMP%] {\n  margin: 0;\n  color: #555;\n  line-height: 1.4;\n  font-size: 0.9rem;\n  word-wrap: break-word;\n}\n/*# sourceMappingURL=job-details.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(JobDetailsComponent, [{
    type: Component,
    args: [{ selector: "app-job-details", standalone: true, imports: [CommonModule, RouterModule, MatProgressSpinnerModule, MatIconModule, MatButtonModule, MatSnackBarModule, MatDialogModule, MatInputModule, MatFormFieldModule, ReactiveFormsModule], template: `<div class="job-details-wrapper">\r
  <!-- Page Header -->\r
  <div class="page-header">\r
    <div class="header-content">\r
      <button mat-button (click)="goBack()" mat-raised-button color="primary">\r
...
\r
  <!-- Success Message -->\r
  <div *ngIf="bidSuccess" class="alert alert-success">\r
    <mat-icon>check_circle</mat-icon>\r
    <span>Successfully submitted your interest in this job!</span>\r
  </div>\r
\r
  <!-- Loading State -->\r
...
\r
  <!-- Job Details Content -->\r
  <div *ngIf="!loading && job" class="job-details-container">\r
    <div class="job-details-card">\r
      <!-- Job Header -->\r
      <div class="job-header">\r
        <div class="job-title-section">\r
          <h1 class="job-title">{{ job.title }}</h1>\r
          <div class="job-meta">\r
            <span class="job-category">{{ job.category?.name || 'Uncategorized' }}</span>\r
            <span class="job-status" [class.status-open]="job.status === 'Open'">\r
              {{ job.status }}\r
            </span>\r
          </div>\r
        </div>\r
        <div class="job-budget">\r
          <span class="budget-label">Budget</span>\r
          <span class="price">{{ formatPrice(job.budget) }}</span>\r
        </div>\r
      </div>\r
\r
      <!-- Job Content -->\r
      <div class="job-content">\r
        <!-- Description Section -->\r
        <section class="job-section">\r
          <h2>Description</h2>\r
          <p class="description">{{ job.description }}</p>\r
        </section>\r
\r
        <!-- Job Details Grid -->\r
        <section class="job-details-grid">\r
          <div class="detail-box">\r
            <div class="detail-header">\r
              <mat-icon>location_on</mat-icon>\r
              <h3>Location</h3>\r
            </div>\r
            <p class="detail-value">{{ job.location }}</p>\r
          </div>\r
\r
          <div class="detail-box">\r
            <div class="detail-header">\r
            ...
            <p class="detail-value">{{ job.timeline }}</p>\r
          </div>\r
\r
          <div class="detail-box">\r
            <div class="detail-header">\r
            ...
            <p class="detail-value">{{ job.createdAt | date: 'MMM dd, yyyy HH:mm' }}</p>\r
          </div>\r
\r
          <div class="detail-box">\r
            <div class="detail-header">\r
            ...
            <p class="detail-value">\r
              {{ job.user?.firstName && job.user?.lastName ? (job.user?.firstName + ' ' + job.user?.lastName) : (job.user?.name || 'User') }}\r
            </p>\r
          </div>\r
        </section>\r
\r
        <!-- Attachments Section (if available) -->\r
        <section *ngIf="job.attachments" class="job-section">\r
          <h2>Attachments</h2>\r
          <div class="attachments">\r
            <div class="attachment-item">\r
              <mat-icon>attach_file</mat-icon>\r
              <span>{{ job.attachments }}</span>\r
            </div>\r
          </div>\r
        </section>\r
\r
        <!-- Status Information -->\r
        <section class="job-section status-section">\r
          <h2>Status Information</h2>\r
          <div class="status-info">\r
            <div class="info-item">\r
              <span class="info-label">Current Status:</span>\r
              <span class="info-value" [class.status-open]="job.status === 'Open'">{{ job.status }}</span>\r
            </div>\r
            <div *ngIf="job.assignedProId" class="info-item">\r
              <span class="info-label">Assigned to:</span>\r
              <span class="info-value">\r
                {{ job.assignedPro?.proName || 'Professional' }}\r
              </span>\r
            </div>\r
            <div *ngIf="!job.assignedProId" class="info-item">\r
              <span class="info-label">Assignment Status:</span>\r
              <span class="info-value status-unassigned">Unassigned - Available for Pro Bid</span>\r
            </div>\r
            <div class="info-item">\r
              <span class="info-label">Your Bid Status:</span>\r
              <div *ngIf="!userHasBid" class="bid-status-container">\r
                <span class="info-value">Not yet bid</span>\r
              </div>\r
              <div *ngIf="userHasBid" class="bid-status-container bid-submitted" [class.bid-rejected]="userBidStatus === 'Rejected'">\r
                <div class="bid-status-header">\r
                  <mat-icon [class.rejected-icon]="userBidStatus === 'Rejected'">{{ userBidStatus === 'Rejected' ? 'cancel' : 'check_circle' }}</mat-icon>\r
                  <span class="bid-status-text">{{ userBidStatus === 'Rejected' ? 'Bid Rejected' : 'Bid Submitted' }}</span>\r
                </div>\r
                <div *ngIf="userBidStatus === 'Rejected' && userBidRejectionReason" class="rejection-reason-box">\r
                  <mat-icon class="reason-icon">info</mat-icon>\r
                  <div>\r
                    <span class="reason-label">Reason:</span>\r
                    <span class="reason-text">{{ userBidRejectionReason }}</span>\r
                  </div>\r
                </div>\r
                <div class="bid-details">\r
                  <!-- Always show Bid Amount if exists -->\r
                  <div *ngIf="userBidAmount" class="bid-detail-item">\r
                    <span class="bid-detail-label">Your Proposed Amount:</span>\r
                    <span class="bid-detail-value amount">\u20B9{{ userBidAmount | number: '1.2-2' }}</span>\r
                  </div>\r
                  <!-- Phase 1A: Commence Date -->\r
                  <div *ngIf="userBidCommenceDate !== null && userBidCommenceDate !== undefined" class="bid-detail-item">\r
                    <span class="bid-detail-label">Commence Date:</span>\r
                    <span class="bid-detail-value">{{ userBidCommenceDate | date: 'MMM dd, yyyy' }}</span>\r
                  </div>\r
                  <!-- Phase 1A: Expected Duration -->\r
                  <div *ngIf="userBidExpectedDuration !== null && userBidExpectedDuration !== undefined" class="bid-detail-item">\r
                    <span class="bid-detail-label">Expected Duration:</span>\r
                    <span class="bid-detail-value">{{ userBidExpectedDuration }} days</span>\r
                  </div>\r
                  <!-- Phase 1A: Materials Needed -->\r
                  <div *ngIf="userBidMaterials && userBidMaterials.length > 0" class="bid-detail-item">\r
                    <span class="bid-detail-label">Materials Needed:</span>\r
                    <p class="bid-detail-value materials">{{ userBidMaterials }}</p>\r
                  </div>\r
                  <!-- Your Message -->\r
                  <div *ngIf="userBidMessage && userBidMessage.length > 0" class="bid-detail-item">\r
                    <span class="bid-detail-label">Your Message:</span>\r
                    <p class="bid-detail-value message">{{ userBidMessage }}</p>\r
                  </div>\r
                  <!-- Phase 1A: Bid Expires -->\r
                  <div *ngIf="userBidExpiresAt !== null && userBidExpiresAt !== undefined" class="bid-detail-item">\r
                    <span class="bid-detail-label">Bid Expires:</span>\r
                    <span class="bid-detail-value">{{ userBidExpiresAt | date: 'MMM dd, yyyy' }}</span>\r
                  </div>\r
                  <!-- Fallback: Show if bid exists but no details (debugging) -->\r
                  <div *ngIf="!userBidAmount && !userBidCommenceDate && !userBidExpectedDuration && !userBidMaterials && !userBidMessage && !userBidExpiresAt" class="bid-detail-item">\r
                    <p style="color: #999; font-size: 0.9rem;">\u2713 Bid submitted on {{ (job.createdAt | date: 'MMM dd, yyyy') }}</p>\r
                  </div>\r
                </div>\r
                <div *ngIf="userBidStatus === 'Rejected' && job.status === 'Open'" class="bid-resubmit-section">\r
                  <p class="resubmit-message">Your bid was not accepted. You can try submit a new bid.</p>\r
                  <button mat-raised-button color="accent" (click)="submitBid()">\r
...
\r
            <!-- Message History Section -->\r
            <div class="info-item" *ngIf="userHasBid && jobMessages.length > 0">\r
              <span class="info-label">Message History:</span>\r
              <div class="messages-section">\r
                <!-- Loading State -->\r
...
\r
                <!-- Messages List -->\r
                <div *ngIf="!loadingMessages && jobMessages.length > 0" class="messages-list">\r
                  <div *ngFor="let msg of jobMessages" class="message-item" [class.sent]="msg.senderType === 'Pro'">\r
                    <div class="message-header">\r
                      <span class="sender-type">{{ msg.senderType === 'Pro' ? 'You' : 'Job Poster' }}</span>\r
                      <span class="message-time">{{ msg.sentAt | date: 'MMM dd, HH:mm' }}</span>\r
                    </div>\r
                    <p class="message-content">{{ msg.content }}</p>\r
                  </div>\r
                </div>\r
              </div>\r
            </div>\r
...
\r
        <!-- Action Buttons -->\r
        <div class="job-actions">\r
        <button mat-raised-button color="primary" class="full-width" (click)="submitBid()" [disabled]="submittingBid || userHasBid">\r
          <mat-icon *ngIf="!submittingBid && !userHasBid">handshake</mat-icon>\r
          <mat-icon *ngIf="userHasBid">check_circle</mat-icon>\r
          <mat-spinner *ngIf="submittingBid" diameter="20" class="button-spinner"></mat-spinner>\r
          {{ userHasBid ? 'Already Bid on This Job' : (submittingBid ? 'Submitting...' : 'Send a Bid') }}\r
        </button>\r
        <button mat-button (click)="goBack()" class="full-width">\r
          <mat-icon>arrow_back</mat-icon>\r
          Back to Available Jobs\r
        </button>\r
      </div>\r
    </div>\r
  </div>\r
</div>\r
`, styles: ['@charset "UTF-8";\n\n/* src/app/features/job-details/job-details.scss */\n.job-details-wrapper {\n  min-height: 100vh;\n  background:\n    linear-gradient(\n      135deg,\n      #f5f7fa 0%,\n      #c3cfe2 100%);\n  padding: 2rem;\n}\n.page-header {\n  max-width: 1000px;\n  margin: 0 auto 2rem;\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n}\n.page-header .header-content {\n  display: flex;\n  gap: 1rem;\n}\n@media (max-width: 768px) {\n  .page-header .header-content {\n    width: 100%;\n    justify-content: space-between;\n  }\n}\n.page-header button {\n  white-space: nowrap;\n}\n.alert {\n  max-width: 1000px;\n  margin: 0 auto 2rem;\n  padding: 1rem;\n  border-radius: 8px;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  font-size: 1rem;\n}\n.alert mat-icon {\n  font-size: 1.25rem;\n  width: 1.25rem;\n  height: 1.25rem;\n}\n.alert.alert-error {\n  background-color: #f8d7da;\n  color: #721c24;\n  border: 1px solid #f5c6cb;\n}\n.alert.alert-success {\n  background-color: #d4edda;\n  color: #155724;\n  border: 1px solid #c3e6cb;\n}\n.loading-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  min-height: 600px;\n  gap: 1rem;\n}\n.loading-container p {\n  color: #666;\n  font-size: 1.1rem;\n}\n.job-details-container {\n  max-width: 1000px;\n  margin: 0 auto;\n}\n.job-details-card {\n  background: white;\n  border-radius: 12px;\n  box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1);\n  overflow: hidden;\n}\n.job-header {\n  padding: 2rem;\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  color: white;\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  gap: 2rem;\n}\n@media (max-width: 768px) {\n  .job-header {\n    flex-direction: column;\n    gap: 1.5rem;\n  }\n}\n.job-title-section {\n  flex: 1;\n}\n.job-title {\n  font-size: 2rem;\n  margin: 0 0 1rem 0;\n  font-weight: 600;\n}\n@media (max-width: 768px) {\n  .job-title {\n    font-size: 1.5rem;\n  }\n}\n.job-meta {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  flex-wrap: wrap;\n}\n.job-meta .job-category {\n  display: inline-block;\n  background-color: rgba(255, 255, 255, 0.2);\n  color: white;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  font-size: 0.95rem;\n  font-weight: 500;\n}\n.job-meta .job-status {\n  display: inline-block;\n  padding: 0.5rem 1rem;\n  border-radius: 4px;\n  font-size: 0.95rem;\n  font-weight: 600;\n  background-color: rgba(255, 255, 255, 0.2);\n}\n.job-meta .job-status.status-open {\n  background-color: #4caf50;\n  color: white;\n}\n.job-budget {\n  text-align: right;\n}\n.job-budget .budget-label {\n  display: block;\n  font-size: 0.9rem;\n  opacity: 0.9;\n  margin-bottom: 0.5rem;\n}\n.job-budget .price {\n  display: block;\n  font-size: 2rem;\n  font-weight: 700;\n}\n.job-content {\n  padding: 2rem;\n}\n.job-section {\n  margin-bottom: 2.5rem;\n}\n.job-section h2 {\n  font-size: 1.3rem;\n  font-weight: 600;\n  color: #333;\n  margin: 0 0 1rem 0;\n  padding-bottom: 0.5rem;\n  border-bottom: 2px solid #f0f0f0;\n}\n.job-section .description {\n  color: #555;\n  line-height: 1.8;\n  font-size: 1rem;\n  margin: 0;\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n.job-details-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));\n  gap: 1.5rem;\n  margin-bottom: 2.5rem;\n}\n.detail-box {\n  background: #f9f9f9;\n  padding: 1.5rem;\n  border-radius: 8px;\n  border-left: 4px solid #667eea;\n}\n.detail-box .detail-header {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  margin-bottom: 1rem;\n}\n.detail-box .detail-header mat-icon {\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n  color: #667eea;\n}\n.detail-box .detail-header h3 {\n  font-size: 0.95rem;\n  font-weight: 600;\n  color: #333;\n  margin: 0;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.detail-box .detail-value {\n  color: #555;\n  font-size: 1rem;\n  margin: 0;\n  line-height: 1.6;\n}\n.attachments {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.attachments .attachment-item {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.75rem;\n  background: #f9f9f9;\n  border-radius: 6px;\n  color: #555;\n}\n.attachments .attachment-item mat-icon {\n  font-size: 1.2rem;\n  width: 1.2rem;\n  height: 1.2rem;\n  color: #667eea;\n}\n.status-section {\n  background: #f9f9f9;\n  padding: 1.5rem;\n  border-radius: 8px;\n  margin-bottom: 2rem;\n}\n.status-section .status-info {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.status-section .status-info .info-item {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.75rem 0;\n  border-bottom: 1px solid #e0e0e0;\n}\n.status-section .status-info .info-item:last-child {\n  border-bottom: none;\n}\n.status-section .status-info .info-item .info-label {\n  font-weight: 600;\n  color: #333;\n}\n.status-section .status-info .info-item .info-value {\n  color: #555;\n  font-weight: 500;\n}\n.status-section .status-info .info-item .info-value.status-open {\n  background-color: #4caf50;\n  color: white;\n  padding: 0.4rem 0.8rem;\n  border-radius: 4px;\n  font-size: 0.9rem;\n}\n.status-section .status-info .info-item .info-value.status-unassigned {\n  background-color: #ff9800;\n  color: white;\n  padding: 0.4rem 0.8rem;\n  border-radius: 4px;\n  font-size: 0.9rem;\n}\n.job-actions {\n  padding: 1.5rem 2rem;\n  background: #f9f9f9;\n  border-top: 1px solid #e0e0e0;\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.job-actions .full-width {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n}\n.job-actions .full-width .button-spinner {\n  display: inline-block;\n  margin: 0;\n}\n@media (max-width: 768px) {\n  .job-actions button {\n    display: block;\n    width: 100%;\n  }\n}\n.back-btn {\n  color: white;\n  background: rgba(255, 255, 255, 0.2);\n}\n.back-btn:hover {\n  background: rgba(255, 255, 255, 0.3);\n}\n@media (max-width: 600px) {\n  .job-details-wrapper {\n    padding: 1rem;\n  }\n  .job-header {\n    padding: 1.5rem;\n    flex-direction: column;\n  }\n  .job-header .job-title {\n    font-size: 1.3rem;\n  }\n  .job-header .job-budget {\n    width: 100%;\n    text-align: left;\n  }\n  .job-header .job-budget .price {\n    font-size: 1.5rem;\n  }\n  .job-content {\n    padding: 1rem;\n  }\n  .job-details-grid {\n    grid-template-columns: 1fr;\n    gap: 1rem;\n  }\n}\n.bid-already-submitted {\n  color: #4caf50;\n  font-weight: 600;\n}\n.bid-already-submitted::before {\n  content: "\\2713  ";\n  margin-right: 0.25rem;\n}\n.bid-status-container {\n  width: 100%;\n  text-align: left;\n}\n.bid-status-container.bid-submitted {\n  background: #f0f8f4;\n  padding: 1rem;\n  border-radius: 8px;\n  border-left: 4px solid #4caf50;\n}\n.bid-status-container.bid-submitted.bid-rejected {\n  background: #fef5f5;\n  border-left-color: #f44336;\n}\n.bid-status-container .bid-status-header {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  margin-bottom: 1rem;\n}\n.bid-status-container .bid-status-header mat-icon {\n  color: #4caf50;\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n}\n.bid-status-container .bid-status-header mat-icon.rejected-icon {\n  color: #f44336;\n}\n.bid-status-container .bid-status-header .bid-status-text {\n  font-weight: 600;\n  color: #2e7d32;\n  font-size: 1rem;\n}\n.bid-status-container.bid-rejected .bid-status-header .bid-status-text {\n  color: #c62828;\n}\n.bid-status-container .rejection-reason-box {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.5rem;\n  background: #fff3f3;\n  border: 1px solid #f44336;\n  border-radius: 6px;\n  padding: 10px 12px;\n  margin-bottom: 1rem;\n}\n.bid-status-container .rejection-reason-box .reason-icon {\n  color: #c62828;\n  font-size: 18px;\n  width: 18px;\n  height: 18px;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.bid-status-container .rejection-reason-box .reason-label {\n  font-weight: 600;\n  color: #c62828;\n  font-size: 0.85rem;\n  margin-right: 4px;\n}\n.bid-status-container .rejection-reason-box .reason-text {\n  color: #555;\n  font-size: 0.9rem;\n  line-height: 1.4;\n}\n.bid-status-container .bid-details {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.bid-status-container .bid-details .bid-detail-item .bid-detail-label {\n  display: block;\n  font-weight: 600;\n  color: #333;\n  font-size: 0.9rem;\n  margin-bottom: 0.25rem;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.bid-status-container .bid-details .bid-detail-item .bid-detail-value {\n  margin: 0;\n  color: #555;\n}\n.bid-status-container .bid-details .bid-detail-item .bid-detail-value.amount {\n  font-size: 1.3rem;\n  font-weight: 700;\n  color: #4caf50;\n}\n.bid-status-container .bid-details .bid-detail-item .bid-detail-value.message,\n.bid-status-container .bid-details .bid-detail-item .bid-detail-value.materials {\n  font-size: 0.95rem;\n  line-height: 1.5;\n  background: white;\n  padding: 0.75rem;\n  border-radius: 6px;\n  border-left: 3px solid #4caf50;\n}\n.bid-status-container .bid-details .bid-resubmit-section {\n  margin-top: 1.5rem;\n  padding-top: 1.5rem;\n  border-top: 1px solid rgba(244, 67, 54, 0.2);\n}\n.bid-status-container .bid-details .bid-resubmit-section .resubmit-message {\n  margin: 0 0 1rem 0;\n  color: #c62828;\n  font-size: 0.9rem;\n  font-style: italic;\n}\n.bid-status-container .bid-details .bid-resubmit-section button {\n  width: 100%;\n  justify-content: center;\n  gap: 8px;\n}\n.bid-status-container .bid-details .bid-resubmit-section button mat-icon {\n  font-size: 1rem;\n  width: 1rem;\n  height: 1rem;\n}\n.bid-status-container .bid-details .messages-section {\n  background: #f9f9f9;\n  border-radius: 8px;\n  padding: 1rem;\n  border: 1px solid #e0e0e0;\n}\n.bid-status-container .bid-details .messages-section .messages-loading {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.75rem;\n  padding: 1rem;\n}\n.bid-status-container .bid-details .messages-section .messages-loading p {\n  margin: 0;\n  color: #666;\n  font-size: 0.9rem;\n}\n.bid-status-container .bid-details .messages-section .messages-list {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item {\n  background: white;\n  padding: 0.75rem;\n  border-radius: 6px;\n  border-left: 3px solid #2196f3;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item.sent {\n  background: #e3f2fd;\n  border-left-color: #1976d2;\n  margin-left: 1rem;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item .message-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 0.5rem;\n  font-size: 0.85rem;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item .message-header .sender-type {\n  font-weight: 600;\n  color: #333;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item .message-header .message-time {\n  color: #999;\n  font-size: 0.8rem;\n}\n.bid-status-container .bid-details .messages-section .messages-list .message-item .message-content {\n  margin: 0;\n  color: #555;\n  line-height: 1.4;\n  font-size: 0.9rem;\n  word-wrap: break-word;\n}\n/*# sourceMappingURL=job-details.css.map */\n'] }]
  }], () => [{ type: JobService }, { type: PaymentService }, { type: Auth }, { type: Router }, { type: ActivatedRoute }, { type: ChangeDetectorRef }, { type: MatDialog }, { type: MatSnackBar }, { type: FormBuilder }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(JobDetailsComponent, { className: "JobDetailsComponent", filePath: "src/app/features/job-details/job-details.ts", lineNumber: 27 });
})();
export {
  JobDetailsComponent
};
//# sourceMappingURL=chunk-DUGGVQYD.js.map
